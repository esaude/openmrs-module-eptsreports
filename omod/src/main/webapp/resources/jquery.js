(function() {
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        find : function(selector) {
            ...
            return this
                    .pushStack(/[^+>] [^+>]/.test(selector) || selector.indexOf("..") > -1 ? jQuery.unique(elems) : elems);
        },
            ...
            return this.each(function() {
                ...
                if (value.constructor == Array && /radio|checkbox/.test(this.type))
                    ...
                    jQuery("option", this).each(
                            function() {
                                this.selected = (jQuery.inArray(this.value, values) >= 0 || jQuery.inArray(this.text,
                                        values) >= 0);
                            });
    ...
    jQuery
            .extend({
                ...
                isXMLDoc : function(elem) {
                    return elem.documentElement && !elem.body || elem.tagName && elem.ownerDocument
                ...
                prop : function(elem, value, type, i, name) {
                    ...
                    return value && value.constructor == Number && type == "curCSS" && !exclude.test(name) ? value
                            + "px" : value;
                },
                                    ...
                                    function(i, elem) {
                                        ...
                                        if (typeof elem == "string") {
                                            ...
                                            elem = elem
                                                    .replace(
                                                            ...
                                                            function(all, front, tag) {
                                                                return tag
                                                                        .match(/^(abbr|br|col|img|input|link|meta|param|hr|area|embed)$/i) ? all : front
                                                                        + "></" + tag + ">";
                                                            });
                                            ...
                                            if (jQuery.browser.msie) {
                                                ...
                                                var tbody = !tags.indexOf("<table") && tags.indexOf("<tbody") < 0 ? div.firstChild
    ...
    jQuery.each([ "Height", "Width" ], function(i, name) {
        ...
        jQuery.fn[type] = function(size) {
            ...
            Math.max(Math.max(document.body["scroll" + name], document.documentElement["scroll" + name]), Math.max(
                ...
                filter : function(t, r, not) {
                    ...
                    while (t && t != last) {
                        ...
                        // We can get a big speed boost by filtering by class here
                            ...
                            test = /(-?)(\d*)n((?:\+|-)?\d*)/.exec(m[3] == "even" && "2n" || m[3] == "odd" && "2n+1"
    ...
    jQuery.event = {
        ...
        add : function(elem, types, handler, data) {
            ...
            var events = jQuery.data(elem, "events") || jQuery.data(elem, "events", {}), handle = jQuery.data(elem,
                    "handle")
            ...
            .extend({
                ...
                httpSuccess : function(xhr) {
                    try {
                        ...
                        return !xhr.status && location.protocol == "file:" || (xhr.status >= 200 && xhr.status < 300)
                                || xhr.status == 304 || xhr.status == 1223 || jQuery.browser.safari
                ...
                httpNotModified : function(xhr, url) {
                    try {
                        ...
                        return xhr.status == 304 || xhrRes == jQuery.lastModified[url] || jQuery.browser.safari
                                && xhr.status == undefined;
                    } catch (e) {
                    }
                    return false;
    ...
    jQuery.fn.extend({
        ...
        toggle : function(fn, fn2) {
            return jQuery.isFunction(fn) && jQuery.isFunction(fn2) ? this._toggle.apply(this, arguments) : fn ? this
                    .animate({
                        height : "toggle",
                        width : "toggle",
                        opacity : "toggle"
    ...
    jQuery.fx.prototype = {
        ...
        step : function(gotoEnd) {
            ...
            if (gotoEnd || t > this.options.duration + this.startTime) {
                ...
                this.pos = jQuery.easing[this.options.easing || (jQuery.easing.swing ? "swing" : "linear")](this.state,
                        n, 0, 1, this.options.duration);
        ...
        if (elem)
            with (jQuery.browser) {
                var parent = elem.parentNode, offsetChild = elem, offsetParent = elem.offsetParent, doc = elem.ownerDocument, safari2 = safari
                        && parseInt(version) < 522 && !/adobeair/i.test(userAgent), css = jQuery.curCSS, fixed = css(
                        elem, "position") == "fixed";
        ...
        jQuery.fn[method] = function(val) {
            ...
            this.each(function() {
                this == window || this == document ? window.scrollTo(!i ? val : jQuery(window).scrollLeft(),
                        i ? val : jQuery(window).scrollTop()) : this[method] = val;
            }) :
