...
public class TxRTTCalculationTest extends DefinitionsFGHLiveTest {
	...
	public void shouldFindPatientsNewlyEnrolledInART() throws EvaluationException {
		...
		CohortDefinition cohortDefinitionC1 = this.resumoMensalAPSSCohortQueries
				.findPatientsWhoAreCurrentlyEnrolledOnArtWithPrevencaoPosetivaD1();

		CohortDefinition numeratorPreviosPeriod = this.txTBCohortQueries.getSpecimenSentCohortDefinition();

		CohortDefinition txCurrWithTPTCompletation = this.tptCompletationCohortQueries.findTxCurrWithTPTCompletation();

		final EvaluatedCohort evaluateCohortDefinition = this.evaluateCohortDefinition(txCurrWithTPTCompletation,
				parameters);
