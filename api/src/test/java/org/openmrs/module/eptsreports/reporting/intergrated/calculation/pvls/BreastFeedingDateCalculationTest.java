...
public class BreastFeedingDateCalculationTest extends BasePatientCalculationTest {
  ...
  public void shouldEvaluatePatientMarkedAsBreastFeedingByLactatinng() {
    ...
    Assert.assertEquals(
        testsHelper.getDate("2018-01-21 00:00:00.0"), evaluatedResult.get(501).getValue());
  ...
  public void shouldEvaluatePatientMarkedAsBreastFeedingByHIVStartDate() {
    ...
    CalculationResultMap evaluatedResult =
        service.evaluate(getCohort(), getCalculation(), getEvaluationContext());
    Assert.assertEquals(
        testsHelper.getDate("2018-06-20 00:00:00.0"), evaluatedResult.get(7).getValue());
  ...
  public void shouldEvaluatePatientMarkedAsBreastFeedingByDeliveryDate() {
    ...
    CalculationResultMap evaluatedResult =
        service.evaluate(getCohort(), getCalculation(), getEvaluationContext());
    Assert.assertEquals(
        testsHelper.getDate("2018-07-01 00:00:00.0"), evaluatedResult.get(91).getValue());
  ...
  public void shouldEvaluatePatientMarkedAsBreastFeedingByPatientState() {
    ...
    CalculationResultMap evaluatedResult =
        service.evaluate(getCohort(), getCalculation(), getEvaluationContext());
    Assert.assertEquals(
        testsHelper.getDate("2018-08-30 00:00:00.0"), evaluatedResult.get(90).getValue());
