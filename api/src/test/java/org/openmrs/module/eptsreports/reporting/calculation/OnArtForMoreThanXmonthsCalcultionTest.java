...
public class OnArtForMoreThanXmonthsCalcultionTest extends BasePatientCalculationTest {
	...
	public void calculate_lastVlShouldBeUsed_whenThereAreMoreThanOne() {
		...
		calculationsTestsCache.createBasicObs(Context.getPatientService().getPatient(999), Context.getConceptService()
		        .getConcept(7777001), Context.getEncounterService().getEncounter(2777005), calculationsTestsCache
		        .getDate("2019-05-10 00:00:00.0"), (Location) getEvaluationContext().getFromCache("location"), 140.0);
		...
		calculationsTestsCache.createBasicObs(Context.getPatientService().getPatient(432), Context.getConceptService()
		        .getConcept(7777002), Context.getEncounterService().getEncounter(3), calculationsTestsCache
		        .getDate("2018-08-12 00:00:00.0"), (Location) getEvaluationContext().getFromCache("location"), Context
