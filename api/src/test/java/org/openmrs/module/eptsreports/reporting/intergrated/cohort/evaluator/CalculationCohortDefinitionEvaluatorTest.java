...
public class CalculationCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
    ...
    public void evaluateShouldReturnPatientIdsFromEvaluatedCalculation() throws EvaluationException {
        CalculationCohortDefinition calculationCohortDefinition = new CalculationCohortDefinition(new PatientIdCalculation());
    ...
    private EvaluatedCohort evaluate(CalculationCohortDefinition calculationCohortDefinition) throws EvaluationException {
        return Context.getService(CohortDefinitionService.class).evaluate(calculationCohortDefinition, null);
    }
