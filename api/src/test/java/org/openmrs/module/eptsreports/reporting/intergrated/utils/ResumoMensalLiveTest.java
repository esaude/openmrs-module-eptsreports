...
public class ResumoMensalLiveTest extends DefinitionsFGHLiveTest {
	...
	public void A1() throws EvaluationException {
		CohortDefinition cd = resumoMensalCohortQueries.getNumberOfPatientsWhoInitiatedPreTarvByEndOfPreviousMonthA1();
	...
	public void A2() throws EvaluationException {
		...
		CohortDefinition cd = resumoMensalCohortQueries.getPatientsWhoInitiatedPreTarvAtAfacilityDuringCurrentMonthA2();
		EvaluatedCohort evaluatedCohort = evaluateCohortDefinition(cd);
	...
	public void B1() throws EvaluationException {
		CohortDefinition cd = resumoMensalCohortQueries.getPatientsWhoInitiatedTarvAtThisFacilityDuringCurrentMonthB1();
		EvaluatedCohort evaluatedCohort = evaluateCohortDefinition(cd);
		assertEquals(1, evaluatedCohort.size());
	...
	public void B2() throws EvaluationException {
		CohortDefinition cd = resumoMensalCohortQueries
