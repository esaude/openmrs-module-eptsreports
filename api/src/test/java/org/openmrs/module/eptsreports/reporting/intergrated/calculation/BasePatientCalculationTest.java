...
public abstract class BasePatientCalculationTest extends BaseModuleContextSensitiveTest {
	...
	public void evaluateShouldReturnMatchedResultMapBySizeAndPrintOutGivenCalculationCohort() {
		...
		CalculationResultMap evaluatedResult = service.evaluate(cohort, calculation, params, getEvaluationContext());
	...
	protected void matchOtherResultsExcept(CalculationResultMap evaluatedResult, Integer... patientsIdNotToMatch) {
	...
	protected boolean matchCalculationResults(CalculationResultMap results1, CalculationResultMap results2) {
