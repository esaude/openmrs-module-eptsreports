...
public abstract class BasePatientCalculationTest extends BaseModuleContextSensitiveTest {
    ...
    public void setUp() throws Exception {
        ...
        setEvaluationContext(calculationsTestsCache.getDate("2019-01-30 00:00:00.0", calculationsTestsCache.DATE_FORMAT));
    ...
    /**
     * This test runs for all classes that extend this class, it's the basic
    ...
    public void evaluate_shouldReturnMatchedResultMapBySizeAndPrintOutGivenCalculationCohort() {
        ...
        CalculationResultMap evaluatedResult = service.evaluate(cohort, calculation, getEvaluationContext());
