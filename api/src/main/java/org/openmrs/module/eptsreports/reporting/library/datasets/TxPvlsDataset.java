...
public class TxPvlsDataset extends BaseDataSet {
    ...
    public DataSetDefinition constructTxPvlsDatset() {
        ...
        dsd.addDimension("age", EptsReportUtils.map(eptsCommonDimension.getAgesDimension(), "endDate=${endDate},location=${location}"));
        ...
        dsd.addColumn("B02", "Breast feeding and NOT documented Numerator", EptsReportUtils.map(
                        ...
                        "");
        dsd.addColumn("B03", "Pregnant and on routine Numerator", EptsReportUtils
                        .map(pregnantIndicators.getPregnantWomenWithSuppressedViralLoadIn12MonthsAndOnRoutineNumerator(), mappings), "");
        ...
        dsd.addColumn("B06", "Breast feeding and NOT documented Denominator", EptsReportUtils.map(
                        breastfeedingIndicators.getBreastfeedingWomenWithViralLoadIn12MonthsAndNotDocumentedDenominator(), mappings), "");
        dsd.addColumn("B07", "Pregnant and on routine Denominator",
                        ...
                        "");
        dsd.addColumn("B08", "Pregnant and NOT documented Denominator", EptsReportUtils
                        .map(pregnantIndicators.getPregnantWomenWithViralLoadIn12MonthsAndNotDocumentedDenominator(), mappings), "");
    ...
    private List<ColumnParameters> getColumnsForAdults() {
        ...
        return Arrays.asList(unknownM, tenTo14M, fifteenTo19M, twentyTo24M, twenty5To29M, thirtyTo34M, thirty5To39M, foutyTo44M,
                        fouty5To49M, above50M, unknownF, tenTo14F, fifteenTo19F, twentyTo24F, twenty5To29F, thirtyTo34F, thirty5To39F,
