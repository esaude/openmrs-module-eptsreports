...
public class TXRetQueries {
  ...
  private static String artTargetInitiationXGenderAtXToYAge =
      "SELECT patient_id\n"
          + "FROM\n"
          + "  (SELECT patient_id,\n"
          + "          min(data_inicio) data_inicio\n"
          ...
          + "   GROUP BY patient_id)inicio_real\n"
          + "INNER JOIN person pe ON inicio_real.patient_id=pe.person_id\n"
          + "WHERE timestampdiff(YEAR, birthdate, data_inicio)>=:minAge\n"
          + "  AND timestampdiff(YEAR, birthdate, data_inicio)<:maxAge\n"
          + "  AND gender=:gender";
  ...
  private static String atleast50YearsOldMalesThatIncreasedHAARTAtARTInitiation =
      "SELECT patient_id\n"
          + "FROM\n"
          + "  (SELECT patient_id,\n"
          + "          min(data_inicio) data_inicio\n"
  ...
  private static String males20To24InitiatedTARTAtStartOfART =
      "SELECT patient_id\n"
          + "FROM\n"
          + "  (SELECT patient_id,\n"
          + "          min(data_inicio) data_inicio\n"
          ...
          + "   GROUP BY patient_id)inicio_real\n"
          + "INNER JOIN person pe ON inicio_real.patient_id=pe.person_id\n"
          + "WHERE timestampdiff(YEAR, birthdate, data_inicio)>=20\n"
          + "  AND timestampdiff(YEAR, birthdate, data_inicio)<25\n"
          + "  AND gender='M'";
  ...
  private static String males15To19WhoIncreasedHARTAtARTInitiation =
      "SELECT patient_id\n"
          + "FROM\n"
          + "  (SELECT patient_id,\n"
          + "          min(data_inicio) data_inicio\n"
          ...
          + "   GROUP BY patient_id)inicio_real\n"
          + "INNER JOIN person pe ON inicio_real.patient_id=pe.person_id\n"
          + "WHERE timestampdiff(YEAR, birthdate, data_inicio)>=15\n"
          + "  AND timestampdiff(YEAR, birthdate, data_inicio)<20\n"
          + "  AND gender='M'";

  private static String males10To14IncreasedARTAtARTInitiation =
      "SELECT patient_id\n"
          + "FROM\n"
          + "  (SELECT patient_id,\n"
          + "          min(data_inicio) data_inicio\n"
  ...
  private static String females20To24InitiatedTARTAtStartOfART =
      "SELECT patient_id\n"
          + "FROM\n"
          + "  (SELECT patient_id,\n"
          + "          min(data_inicio) data_inicio\n"
  ...
  public static String artTargetInitiationXGenderAtXToYAge() {
    return artTargetInitiationXGenderAtXToYAge;
  }
  ...
  public static String atleast50YearsOldMalesThatIncreasedHAARTAtARTInitiation() {
    return atleast50YearsOldMalesThatIncreasedHAARTAtARTInitiation;
  }

  public static String males20To24InitiatedTARTAtStartOfART() {
    return males20To24InitiatedTARTAtStartOfART;
  }
  ...
  public static String males15To19WhoIncreasedHARTAtARTInitiation() {
    return males15To19WhoIncreasedHARTAtARTInitiation;
  }

  public static String males10To14IncreasedARTAtARTInitiation() {
    return males10To14IncreasedARTAtARTInitiation;
  }

  public static String females20To24InitiatedTARTAtStartOfART() {
    return females20To24InitiatedTARTAtStartOfART;
  }
}
