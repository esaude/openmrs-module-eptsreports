...
public class EriDSDCohortQueries {
	...
	/**
	 * D1: Number of active, stable, patients on ART. Combinantion of Criteria
	 * 1,2,3,4,5
	 */
	public CohortDefinition getAllPatientsWhoAreActiveAndStable() {
		...
		cd.addSearch("1", EptsReportUtils.map(txCurrCohortQueries.getTxCurrCompositionCohort(cohortName, true),
				"onOrBefore=${endDate},location=${location}"));
		cd.addSearch("2", EptsReportUtils.map(ageCohortQueries.createXtoYAgeCohort("moreThanOrEqual0Years", 0, 200),
				"effectiveDate=${endDate}"));
		cd.addSearch("3", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
				"startDate=${endDate-9m},endDate=${endDate},location=${location}"));
		cd.addSearch("4", EptsReportUtils.map(getBreastfeedingComposition(),
				"onOrAfter=${endDate-18m},onOrBefore=${endDate},location=${location}"));
		cd.addSearch("5", EptsReportUtils.map(getPatientsWhoAreStable(),
	...
	/**
	 * Filter patients (from 4) who are considered stable according to criteria 5:
	 * a,b,c,d,e,f
	 *
	 * @return
	 */
	public CohortDefinition getPatientsWhoAreStable() {
		...
		cd.addSearch("A",
				EptsReportUtils.map(getPatientsWhoAreStableA(), "onOrBefore=${endDate},location=${location}"));
		cd.addSearch("B", EptsReportUtils.map(getPatientsWithViralLoadLessThan1000Within12Months(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
		cd.addSearch("C", EptsReportUtils.map(getCD4CountAndCD4PercentCombined(),
				"startDate=${endDate-12m},endDate=${endDate},location=${location}"));
		cd.addSearch("D", EptsReportUtils.map(getPatientsWhoAreOnWhoStage3Or4InLastEncounter(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
		cd.addSearch("F", EptsReportUtils.map(
				genericCohortQueries.hasCodedObs(hivMetadata.getAdverseReaction(),
						BaseObsCohortDefinition.TimeModifier.ANY, SetComparator.IN,
						Arrays.asList(hivMetadata.getAdultoSeguimentoEncounterType(),
								hivMetadata.getARVPediatriaSeguimentoEncounterType()),
						Arrays.asList(hivMetadata.getNeutropenia(), hivMetadata.getPancreatitis(),
								hivMetadata.getHepatotoxicity(), hivMetadata.getPsychologicalChanges(),
								hivMetadata.getMyopathy(), hivMetadata.getSkinAllergy(), hivMetadata.getLipodystrophy(),
								hivMetadata.getLacticAcidosis(), hivMetadata.getPeripheralNeuropathy(),
								hivMetadata.getDiarrhea(), hivMetadata.getOtherDiagnosis())),
				"onOrAfter=${startDate},onOrBefore=${endDate},locationList=${location}"));
		cd.addSearch("patientsWithViralLoad", EptsReportUtils.map(hivCohortQueries.getPatientsViralLoadWithin12Months(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	/**
	 * 5A Patients who are on ART for at least 12 months (if patients age >=2 and
	 * <=9) or On ART for at least 6 months (if patients age >=10)
	 *
	 * @return
	 */
	private CohortDefinition getPatientsWhoAreStableA() {
		CalculationCohortDefinition cd = new CalculationCohortDefinition("onArtAtleastXmonths",
	...
	/**
	 * 5C One CD4 Lab result > 750 cels/mm3 or > 15% in last ART year (if patients
	 * age >=2 and <=4) or One CD4 result > 200 cels/mm3 in last ART year (if
	 * patients age >=5 and <=9) 5C (i) 5C (ii)
	 *
	 * @return
	 */
	private CohortDefinition getCD4CountAndCD4PercentCombined() {
		...
		cd.addSearch("CI", EptsReportUtils.map(getCD4CountAndCD4Percent1(),
				"startDate=${endDate-12m},endDate=${endDate},location=${location}"));
		cd.addSearch("CII", EptsReportUtils.map(getCD4CountAndCD4Percent2(),
				"startDate=${endDate-12m},endDate=${endDate},location=${location}"));
	...
	/**
	 * 5C (i) One CD4 Lab result > 750 cels/mm3 or > 15% in last ART year (if
	 * patients age >=2 and <=4)
	 *
	 * @return
	 */
	private CohortDefinition getCD4CountAndCD4Percent1() {
		...
		cd.addSearch("Cd4Abs", EptsReportUtils.map(
				genericCohortQueries.hasNumericObs(hivMetadata.getCD4AbsoluteOBSConcept(),
						BaseObsCohortDefinition.TimeModifier.ANY, RangeComparator.GREATER_THAN, 750.0, null, null,
						Arrays.asList(hivMetadata.getAdultoSeguimentoEncounterType(),
								hivMetadata.getARVPediatriaSeguimentoEncounterType(),
								hivMetadata.getMisauLaboratorioEncounterType())),
				"onOrAfter=${endDate-12m},onOrBefore=${endDate},locationList=${location}"));
		cd.addSearch("Cd4Lab", EptsReportUtils.map(
				genericCohortQueries.hasNumericObs(hivMetadata.getCD4AbsoluteConcept(),
						BaseObsCohortDefinition.TimeModifier.ANY, RangeComparator.GREATER_THAN, 750.0, null, null,
						Arrays.asList(hivMetadata.getAdultoSeguimentoEncounterType(),
								hivMetadata.getARVPediatriaSeguimentoEncounterType(),
								hivMetadata.getMisauLaboratorioEncounterType())),
				"onOrAfter=${endDate-12m},onOrBefore=${endDate},locationList=${location}"));
		cd.addSearch("Cd4Percent", EptsReportUtils.map(
				genericCohortQueries.hasNumericObs(hivMetadata.getCD4PercentConcept(),
						BaseObsCohortDefinition.TimeModifier.ANY, RangeComparator.GREATER_THAN, 15.0, null, null,
						Arrays.asList(hivMetadata.getAdultoSeguimentoEncounterType(),
								hivMetadata.getARVPediatriaSeguimentoEncounterType(),
								hivMetadata.getMisauLaboratorioEncounterType())),
				"onOrAfter=${endDate-12m},onOrBefore=${endDate},locationList=${location}"));
		cd.addSearch("Age",
				EptsReportUtils.map(ageCohortQueries.createXtoYAgeCohort("2-4", 2, 4), "effectiveDate=${endDate}"));
	...
	/**
	 * 5C (ii) One CD4 result > 200 cels/mm3 in last ART year (if patients age >=5
	 * years)
	 *
	 * @return
	 */
	private CohortDefinition getCD4CountAndCD4Percent2() {
		...
		cd.addSearch("CD4Abs", EptsReportUtils.map(
				genericCohortQueries.hasNumericObs(hivMetadata.getCD4AbsoluteOBSConcept(),
						BaseObsCohortDefinition.TimeModifier.ANY, RangeComparator.GREATER_THAN, 200.0, null, null,
						Arrays.asList(hivMetadata.getAdultoSeguimentoEncounterType(),
								hivMetadata.getARVPediatriaSeguimentoEncounterType(),
								hivMetadata.getMisauLaboratorioEncounterType())),
				"onOrAfter=${endDate-12m},onOrBefore=${endDate},locationList=${location}"));
		cd.addSearch("Cd4Lab", EptsReportUtils.map(
				genericCohortQueries.hasNumericObs(hivMetadata.getCD4AbsoluteConcept(),
						...
						Arrays.asList(hivMetadata.getAdultoSeguimentoEncounterType(),
								...
								hivMetadata.getMisauLaboratorioEncounterType())),
				"onOrAfter=${endDate-12m},onOrBefore=${endDate},locationList=${location}"));
		cd.addSearch("Age", EptsReportUtils.map(ageCohortQueries.createXtoYAgeCohort("greaterThan5", 5, 900),
				"effectiveDate=${endDate}"));
	...
	public CohortDefinition getPatientsWhoAreNotPregnantAndNotBreastfeedingD1() {
		...
		cd.addSearch("breastfeeding", EptsReportUtils.map(getBreastfeedingComposition(),
				"onOrAfter=${endDate-18m},onOrBefore=${endDate},location=${location}"));
		cd.addSearch("pregnant", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
				"startDate=${endDate-9m},endDate=${endDate},location=${location}"));
		cd.addSearch("activeAndStable", EptsReportUtils.map(getAllPatientsWhoAreActiveAndStable(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	private CohortDefinition getPatientsWhoAreOnWhoStage3Or4InLastEncounter() {
		...
		sql.setQuery(DsdQueries.getPatientsWithWHOStage3Or4(hivMetadata.getCurrentWHOHIVStageConcept().getConceptId(),
				hivMetadata.getAdultoSeguimentoEncounterType().getEncounterTypeId(),
				hivMetadata.getARVPediatriaSeguimentoEncounterType().getEncounterTypeId(),
	...
	public CohortDefinition getPatientsWhoAreActiveAndUnstable() {
		CompositionCohortDefinition cd = new CompositionCohortDefinition();
		String cohortName = "All  patients  (adults  and  children)  currently  receiving  treatment (TxCurr)";
		...
		cd.addSearch("allPatientsTxCurr",
				EptsReportUtils.map(txCurrCohortQueries.getTxCurrCompositionCohort(cohortName, true),
						"onOrBefore=${endDate},location=${location}"));
		cd.addSearch("activeAndStablePatients", EptsReportUtils.map(getAllPatientsWhoAreActiveAndStable(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));

		cd.addSearch("breastfeedingExcludingPregnantPatients", EptsReportUtils.map(getBreastfeedingExcludingPregnantPatients(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));

		cd.addSearch("pregnantIncludesBreatFeeding", EptsReportUtils.map(getPregnantIncludesBreatFeeding(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));

		cd.addSearch("tbPatient", EptsReportUtils.map(txTBCohortQueries.getInTBProgram(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
 
		cd.setCompositionString("allPatientsTxCurr AND NOT (activeAndStablePatients  OR tbPatient OR breastfeedingExcludingPregnantPatients OR pregnantIncludesBreatFeeding  ) ");
	...
	public CohortDefinition getPatientsWhoAreNotPregnantAndNotBreastfeedingD2() {
		...
		cd.addSearch("pregnant", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
				"startDate=${endDate-9m},endDate=${endDate},location=${location}"));
		cd.addSearch("activeAndUnstable", EptsReportUtils.map(getPatientsWhoAreActiveAndUnstable(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	public CohortDefinition getPatientsWhoAreBreastFeedingAndNotPregnant() {
		...
		cd.setName("Patients who are breastfeeding: includes all breastfeeding patients excluding pregnant patients");
		cd.addParameter(new Parameter("startDate", "Start Date", Date.class));
		cd.addParameter(new Parameter("endDate", "End Date", Date.class));
		cd.addParameter(new Parameter("location", "Location", Location.class));
	...
	/**
	 * D2: Get Patients who are pregnant including those that are pregnant and
	 * breastfeeding
	 *
	 * @return
	 */
	...
	/**
	 * N1: Number of active on ART whose next ART pick-up is schedule for 83-97 days
	 * after the date of their last ART drug pick-up (Fluxo Rápido)
	 *
	 * @return
	 */
	public CohortDefinition getPatientsWhoAreActiveWithNextPickupAs3Months() {
		...
		cd.addSearch("TxCurr", EptsReportUtils.map(txCurrCohortQueries.getTxCurrCompositionCohort(cohortName, true),
				"onOrBefore=${endDate},location=${location}"));
		cd.addSearch("scheduled",
				EptsReportUtils.map(
						getPatientsScheduled(hivMetadata.getReturnVisitDateForArvDrugConcept(),
								Arrays.asList(hivMetadata.getARVPharmaciaEncounterType()), 97, 83),
						"onOrBefore=${endDate},location=${location}"));
	 ...
	 * @return
	 */
	private CohortDefinition getPatientsScheduled(Concept conceptId, List<EncounterType> encounterTypes,
			Integer upperBound, Integer lowerBound) {
		CalculationCohortDefinition cd = new CalculationCohortDefinition("scheduledPatients",
	...
	/**
	 * N1 STABLE: Get number of active on ART whose next ART pick-up is schedule for
	 * 83-97 days after the date of their last ART drug pick-up
	 *
	 * @return
	 */
	public CohortDefinition getPatientsWhoAreActiveWithNextPickupAs3MonthsAndStable() {
		...
		cd.addSearch("patientsWithNextPickupAs3Months", EptsReportUtils
				.map(getPatientsWhoAreActiveWithNextPickupAs3Months(), "endDate=${endDate},location=${location}"));
		cd.addSearch("patientsWhoAreStable", EptsReportUtils.map(getPatientsWhoAreStable(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	/**
	 * N1 UNSTABLE: Get number of active on ART whose next ART pick-up is schedule
	 * for 83-97 days after the date of their last ART drug pick-up
	 *
	 * @return
	 */
	public CohortDefinition getPatientsWhoAreActiveWithNextPickupAs3MonthsAndUnstable() {
		...
		cd.addSearch("patientsWithNextPickupDate", EptsReportUtils.map(getPatientsWhoAreActiveWithNextPickupAs3Months(),
	...
	public CohortDefinition getPatientsWhoAreNotPregnantAndNotBreastfeedingN1Stable() {
		...
		cd.addSearch("pregnant", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
				"startDate=${endDate-9m},endDate=${endDate},location=${location}"));
		cd.addSearch("activeAndStableN1", EptsReportUtils.map(getPatientsWhoAreActiveWithNextPickupAs3MonthsAndStable(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	public CohortDefinition getPatientsWhoAreNotPregnantAndNotBreastfeedingN1Unstable() {
		...
		cd.addSearch("patientsWithNextPickupDate", EptsReportUtils.map(getPatientsWhoAreActiveWithNextPickupAs3Months(),
				"endDate=${endDate},location=${location}"));
		cd.addSearch("patientsWhoAreStable",
				EptsReportUtils.map(getPatientsWhoAreActiveWithNextPickupAs3MonthsAndStable(),
						"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	public CohortDefinition getPatientsWhoAreBreastfeedingAndNotPregnantN1() {
		...
		cd.addSearch("breastfeedingN1", EptsReportUtils.map(getBreastfeedingComposition(),
				"onOrAfter=${endDate-18m},onOrBefore=${endDate},location=${location}"));
		cd.addSearch("pregnantN1", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
				"startDate=${endDate-9m},endDate=${endDate},location=${location}"));
		cd.addSearch("activeWithNextPickupAs3Months",
				EptsReportUtils.map(getPatientsWhoAreActiveWithNextPickupAs3Months(),
						"startDate=${startDate},endDate=${endDate},location=${location}"));

		cd.setCompositionString("activeWithNextPickupAs3Months AND (breastfeedingN1 AND NOT pregnantN1)");
	...
	/**
	 * N2 : Get the number of active patients on ART whose next clinical
	 * consultation is scheduled 175-190 days after the date of the last clinical
	 * consultation
	 *
	 * @return
	 */
	public CohortDefinition getPatientsWithNextConsultationScheduled175To190Days() {
		CompositionCohortDefinition cd = new CompositionCohortDefinition();
		String cohortName = "N2: Number of active patients on ART whose next clinical consultation is scheduled 175-190 days after the date of the last clinical consultation";
		...
		cd.addSearch("TxCurr", EptsReportUtils.map(txCurrCohortQueries.getTxCurrCompositionCohort(cohortName, true),
				"onOrBefore=${endDate},location=${location}"));
		cd.addSearch("scheduledN2",
				EptsReportUtils.map(
						getPatientsScheduled(hivMetadata.getReturnVisitDateConcept(),
								Arrays.asList(hivMetadata.getARVPediatriaSeguimentoEncounterType(),
	...
	/**
	 * N2 STABLE: Get number of active patients on ART whose next clinical
	 * consultation is scheduled 175-190 days after the date of the last clinical
	 * consultation
	 *
	 * @return
	...
	public CohortDefinition getPatientsWithNextConsultationScheduled175To190DaysStable() {
		...
		cd.addSearch("allPatients", EptsReportUtils.map(getPatientsWithNextConsultationScheduled175To190Days(),
				"endDate=${endDate},location=${location}"));
		cd.addSearch("stablePatients", EptsReportUtils.map(getPatientsWhoAreStable(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	/**
	 * N2 UNSTABLE: Get number of active patients on ART whose next clinical
	 * consultation is scheduled 175-190 days after the date of the last clinical
	 * consultation
	 *
	 * @return
	...
	public CohortDefinition getPatientsWhoAreNotPregnantAndNotBreastfeedingN2Unstable() {
		...
		cd.setCompositionString("allPatients AND NOT stablePatients AND NOT pregnant AND NOT breastfeeding");
	...
	public CohortDefinition getPatientsWhoAreNotPregnantAndNotBreastfeedingN2Stable() {
		...
		cd.addSearch("pregnant", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
				"startDate=${endDate-9m},endDate=${endDate},location=${location}"));
		cd.addSearch("activeAndStableN2",
				EptsReportUtils.map(getPatientsWithNextConsultationScheduled175To190DaysStable(),
						"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	public CohortDefinition getPatientsWhoAreBreastfeedingAndNotPregnantN2() {
		...
		cd.addSearch("breastfeedingN2", EptsReportUtils.map(getBreastfeedingComposition(),
				"onOrAfter=${endDate-18m},onOrBefore=${endDate},location=${location}"));
		cd.addSearch("pregnantN2", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
				"startDate=${endDate-9m},endDate=${endDate},location=${location}"));
		cd.addSearch("activeAndScheduled175To190DaysN2",
				EptsReportUtils.map(getPatientsWithNextConsultationScheduled175To190Days(),
						"startDate=${startDate},endDate=${endDate},location=${location}"));

		cd.setCompositionString("activeAndScheduled175To190DaysN2 AND (breastfeedingN2 AND NOT pregnantN2)");
	...
	/**
	 * N3: Get number of active patients on ART that are participating in GAAC at
	 * the end of the month prior to month of results submission deadline.
	 *
	 * @return
	 */
	public CohortDefinition getPatientsWhoAreActiveAndParticpatingInGaac() {
		...
		cd.addSearch("TxCurr", EptsReportUtils.map(txCurrCohortQueries.getTxCurrCompositionCohort(cohortName, true),
				"onOrBefore=${endDate},location=${location}"));
		cd.addSearch("patientsEnrolledOnGaac", EptsReportUtils.map(getAllPatientsEnrolledOnGaac(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	/**
	 * N3 STABLE: Get number of active patients on ART that are participating in
	 * GAAC at the end of the month prior to month of results submission deadline.
	 *
	 * @return
	 */
	public CohortDefinition getPatientsWhoAreActiveAndParticpatingInGaacStable() {
		...
		cd.addSearch("allPatientsN3Stable", EptsReportUtils.map(getPatientsWhoAreActiveAndParticpatingInGaac(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
		cd.addSearch("stablePatientsN3Stable", EptsReportUtils.map(getPatientsWhoAreStable(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	/**
	 * N3 UNSTABLE: Get number of active patients on ART that are participating in
	 * GAAC at the end of the month prior to month of results submission deadline.
	 *
	 * @return
	 */
	public CohortDefinition getPatientsWhoAreActiveAndParticpatingInGaacUnstable() {
		...
		cd.addSearch("allPatientsN3InGaac", EptsReportUtils.map(getPatientsWhoAreActiveAndParticpatingInGaac(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
		cd.addSearch("breastfeeding", EptsReportUtils.map(getBreastfeedingComposition(),
				"onOrAfter=${endDate-18m},onOrBefore=${endDate},location=${location}"));
		cd.addSearch("pregnant", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
		...
		cd.setCompositionString("allPatientsN3InGaac AND (NOT stablePatientsN3Stable OR breastfeeding OR pregnant)");
	...
	public CohortDefinition getPatientsWhoAreNotPregnantAndNotBreastfeedingN3Stable() {
		...
		cd.addSearch("pregnant", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
				"startDate=${endDate-9m},endDate=${endDate},location=${location}"));
		cd.addSearch("activeAndStableN3", EptsReportUtils.map(getPatientsWhoAreActiveAndParticpatingInGaacStable(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	public CohortDefinition getPatientsWhoAreNotPregnantAndNotBreastfeedingN3Unstable() {
		...
		cd.setCompositionString("allPatientsN3InGaac AND NOT stablePatients AND NOT pregnant AND NOT breastfeeding");
	...
	public CohortDefinition getPatientsWhoAreBreastfeedingAndNotPregnantN3() {
		...
		cd.addSearch("breastfeedingN3", EptsReportUtils.map(getBreastfeedingComposition(),
				"onOrAfter=${endDate-18m},onOrBefore=${endDate},location=${location}"));
		cd.addSearch("pregnantN3", EptsReportUtils.map(txNewCohortQueries.getPatientsPregnantEnrolledOnART(),
				"startDate=${endDate-9m},endDate=${endDate},location=${location}"));
		cd.addSearch("activeOnGAACN3", EptsReportUtils.map(getPatientsWhoAreActiveAndParticpatingInGaac(),
				"startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	public CohortDefinition getBreastfeedingComposition() {
		...
		cd.addSearch("DATAPARTO", EptsReportUtils.map(txNewCohortQueries.getPatientsWithUpdatedDepartureInART(),
				"value1=${onOrAfter},value2=${onOrBefore},locationList=${location}"));
		cd.addSearch("INICIOLACTANTE", EptsReportUtils.map(getBreastfeedingPatientsStartingART(),
				"startDate=${onOrAfter},endDate=${onOrBefore},location=${location}"));
		cd.addSearch("LACTANTEPROGRAMA",
				EptsReportUtils.map(txNewCohortQueries.getPatientsWhoGaveBirthWithinReportingPeriod(),
						"startDate=${onOrAfter},endDate=${onOrBefore},location=${location}"));
		cd.addSearch("FEMININO", EptsReportUtils.map(genderCohorts.femaleCohort(), ""));
		cd.addSearch("LACTANTE", EptsReportUtils.map(getBreastfeedingPatients(),
				"startDate=${onOrAfter},endDate=${onOrBefore},location=${location}"));

		String compositionString = "(DATAPARTO OR INICIOLACTANTE OR LACTANTEPROGRAMA OR LACTANTE) AND FEMININO";
	...
	/**
	 * Custom implementation of LACTANTE query to correctly pick breastfeeding
	 * patients
	 *
	...
	public CohortDefinition getBreastfeedingPatients() {
		...
		cd.addParameter(new Parameter("endDate", "End Date", Date.class));
		cd.addParameter(new Parameter("location", "Location", Location.class));
		cd.setQuery(BreastfeedingQueries.getLactatingPatients(commonMetadata.getBreastfeeding().getConceptId(),
	...
	/**
	 * Custom implementation of INICIOLACTANTE query to correctly pick breastfeeding
	 * patients starting ARV treatement
	 *
	 * @return CohortDefinitions
	 */
	public CohortDefinition getBreastfeedingPatientsStartingART() {
		...
		cd.addParameter(new Parameter("endDate", "End Date", Date.class));
		cd.addParameter(new Parameter("location", "Location", Location.class));
		cd.setQuery(BreastfeedingQueries.getLactatingPatientsStartingART(
				hivMetadata.getCriteriaForArtStart().getConceptId(), commonMetadata.getBreastfeeding().getConceptId(),
				hivMetadata.getAdultoSeguimentoEncounterType().getEncounterTypeId()));
		return cd;
	}

	/**
	 * THE BELOW CODE IS COMMENTED OUT. THE CODE IS FOR INDICATOR: Number of active
	 * patients on ART who participate in >=1 measured DSD model THE INDICATOR WILL
	 * NOT BE INCLUDED IN THIS INITIAL RELEASE OF THE DSD REPORTS.
	 *
	 * <p>
	 * Get the number of active patients on ART who participate in >=1 measured DSD
	 * model The indicator has been commented out in this release.
	 *
	 * @return
	 */
	/*
	 * public CohortDefinition getPatientsWhoAreActiveAndParticipateInDsdModel() {
	 * CompositionCohortDefinition cd = new CompositionCohortDefinition(); String
	 * cohortName = "All patients (Adult and Children) included in TxCurr";
	 * 
	 * cd.
	 * setName("N: Number of active patients on ART who participate in >=1 measured DSD model"
	 * ); cd.addParameter(new Parameter("startDate", "Start Date", Date.class));
	 * cd.addParameter(new Parameter("endDate", "End Date", Date.class));
	 * cd.addParameter(new Parameter("location", "Location", Location.class));
	 * 
	 * cd.addSearch( "allPatientsTxCurrDsdModel", EptsReportUtils.map(
	 * txCurrCohortQueries.getTxCurrCompositionCohort(cohortName, true),
	 * "onOrBefore=${endDate},location=${location}")); cd.addSearch(
	 * "patientsParticipatingInDsdModel", EptsReportUtils.map(
	 * getAllPatientsParticipatingInDsdModel(),
	 * "endDate=${endDate},location=${location}"));
	 * 
	 * cd.
	 * setCompositionString("allPatientsTxCurrDsdModel AND patientsParticipatingInDsdModel"
	 * );
	 * 
	 * return cd; }
	 */
	 ...
	 * cd.addParameter(new Parameter("location", "Location", Location.class));
	 * 
	 * cd.addSearch( "allPatientsInDsdModel", EptsReportUtils.map(
	 * getPatientsWhoAreActiveAndParticipateInDsdModel(),
	 * "endDate=${endDate},location=${location}")); cd.addSearch(
	 * "patientsWhoAreStable", EptsReportUtils.map(getPatientsWhoAreStable(),
	 * "endDate=${endDate}"));
	 * 
	 ...
	 * cd.addParameter(new Parameter("location", "Location", Location.class));
	 * 
	 * cd.addSearch( "patientsInDsdModel", EptsReportUtils.map(
	 * getPatientsWhoAreActiveAndParticipateInDsdModel(),
	 * "endDate=${endDate},location=${location}")); cd.addSearch(
	 * "stablePatientsDsdModel", EptsReportUtils.map(
	 * getPatientsWhoAreActiveAndParticipateInDsdModelStable(),
	 * "endDate=${endDate},location=${location}"));
	 * 
	 ...
	 * "startDate=${startDate},endDate=${endDate},location=${location}"));
	 * cd.addSearch( "activeAndUnstable", EptsReportUtils.map(
	 * getPatientsWhoAreActiveAndParticipateInDsdModelUnstable(),
	 * "startDate=${startDate},endDate=${endDate},location=${location}"));
	 * 
	 * cd.
	 * setCompositionString("activeAndUnstable AND (breastfeeding AND NOT pregnant)"
	 * );
	 * 
	 * return cd; }
	 */
	 ...
	 * cd.addParameter(new Parameter("location", "Location", Location.class));
	 * 
	 * cd.setQuery( DsdQueries.getPatientsParticipatingInDsdModel(
	 ...
	 * hivMetadata.getContinueRegimen().getConceptId())); return cd; }
	 */

	private CohortDefinition getBreastfeedingExcludingPregnantPatients() {
		CompositionCohortDefinition cd = new CompositionCohortDefinition();

		cd.setName("Breastfeeding Excluding Pregnant Patients");
		cd.addParameter(new Parameter("startDate", "Start Date", Date.class));
		cd.addParameter(new Parameter("endDate", "End Date", Date.class));
		cd.addParameter(new Parameter("location", "Location", Location.class));
	...
	private CohortDefinition getPregnantIncludesBreatFeeding() {

		CompositionCohortDefinition cd = new CompositionCohortDefinition();

		cd.setName("Pregnant Patients and Breastfeeding  ");
		cd.addParameter(new Parameter("startDate", "Start Date", Date.class));
		cd.addParameter(new Parameter("endDate", "End Date", Date.class));
		cd.addParameter(new Parameter("location", "Location", Location.class));
