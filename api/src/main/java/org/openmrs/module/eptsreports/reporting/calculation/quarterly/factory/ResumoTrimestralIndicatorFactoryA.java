...
import org.openmrs.module.eptsreports.reporting.calculation.quarterly.indicator.ResumoTrimestralQuarterlyIndicatorCalculationA;
...
public class ResumoTrimestralIndicatorFactoryA {
  ...
  Map<Month, ResumoTrimestralIndicatorCalculationA> mapArtUtils = new HashMap<>();

  Map<QUARTERLIES, ResumoTrimestralQuarterlyTotalCalculation> mapArtQuartersUtil = new HashMap<>();
  ...
  public ResumoTrimestralIndicatorCalculationA getResumoTrimestralCalculator(Month month) {
    return mapArtUtils.get(month);
  }

  public ResumoTrimestralQuarterlyTotalCalculation getResumoTrimestralQuartelyCalculation(
      QUARTERLIES quarter) {
  ...
  public static class ResumoTrimestralArtQuarterOneCalculation
      extends ResumoTrimestralQuarterlyIndicatorCalculationA {
