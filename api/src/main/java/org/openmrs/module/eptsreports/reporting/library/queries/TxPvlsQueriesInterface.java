    ...
    public static final String
        findBreastfeedingWomanWhoHaveMoreThan3MonthsOnArtWithViralLoadRegisteredInTheLast12Months =
            "																																															"
                ...
                + "						inner join encounter e on p.patient_id=e.patient_id    																																																								"
                + "						inner join obs o on e.encounter_id=o.encounter_id    																																																								"
                + "					where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (13,6,9,53,51) and  o.concept_id in (856,1305) and o.obs_datetime between date_add(date_add(:endDate, interval -12 MONTH), interval 1 day) and :endDate and e.location_id=:location group by p.patient_id   		"
                + "				)    																																																																						"
                + "		carga_viral on inicio_real.patient_id=carga_viral.patient_id    																																																									"
                + "			left join    																																																																					"
                + "				(	select p.patient_id,e.encounter_datetime data_gravida from patient p     																																																				"
