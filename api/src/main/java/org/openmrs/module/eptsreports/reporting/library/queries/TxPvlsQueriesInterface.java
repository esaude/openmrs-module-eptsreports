    ...
    public static final String
        findPregnantWomanWhoHaveMoreThan3MonthsOnArtWithViralLoadRegisteredInTheLast12Months =
            "select patient_id from  ( "
                + "select inicio_real.patient_id,inicio_real.data_inicio,carga_viral.data_carga, gravida_real.data_gravida,lactante_real.data_parto,if(gravida_real.data_gravida is null and lactante_real.data_parto is null,null,if(gravida_real.data_gravida is null,1, if(lactante_real.data_parto is null,2,if(max(lactante_real.data_parto)>=max(gravida_real.data_gravida),1,2)))) decisao from ( "
                + "Select patient_id,min(data_inicio) data_inicio from( "
                + "Select p.patient_id,min(e.encounter_datetime) data_inicio from patient p "
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on o.encounter_id=e.encounter_id "
                ...
                + "union "
                + "select pg.patient_id,min(date_enrolled) data_inicio from patient p inner join patient_program pg on p.patient_id=pg.patient_id "
                + "where pg.voided=0 and p.voided=0 and program_id=2 and date_enrolled<=:endDate and location_id=:location group by pg.patient_id union "
                + "SELECT e.patient_id, MIN(e.encounter_datetime) AS data_inicio  FROM patient p "
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "WHERE p.voided=0 and e.encounter_type=18 AND e.voided=0 and e.encounter_datetime<=:endDate and e.location_id=:location GROUP BY p.patient_id "
                + "union "
                ...
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
                + "where p.voided=0 and e.voided=0 and o.voided=0 and concept_id=1982 and value_coded in (44,1465) and  e.encounter_type in (5,6) and e.encounter_datetime  between date_add(:endDate, interval -24 MONTH) and :endDate and e.location_id=:location "
                + "union "
                + "Select p.patient_id,e.encounter_datetime data_gravida from patient p "
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
                ...
                + "union "
                + "Select p.patient_id,e.encounter_datetime data_gravida from patient p inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
                ...
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
                + "where p.voided=0 and e.voided=0 and o.voided=0 and o.concept_id=5272 and o.value_coded=1065 and  e.encounter_type=53 and e.encounter_datetime between date_add(:endDate, interval -24 MONTH) and :endDate and e.location_id=:location "
                + "union "
                + "Select p.patient_id,e.encounter_datetime data_gravida from patient p "
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
                + "where p.voided=0 and e.voided=0 and o.voided=0 and o.concept_id=1465 and  e.encounter_type=6 and e.encounter_datetime between date_add(:endDate, interval -24 MONTH) and :endDate and e.location_id=:location "
                ...
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
                + "where p.voided=0 and e.voided=0 and o.voided=0 and concept_id=6332 and value_coded=1065 and  e.encounter_type in (6,53) and e.encounter_datetime between date_add(:endDate, interval -36 MONTH) and :endDate and e.location_id=:location "
                + "union "
                + "Select p.patient_id, e.encounter_datetime data_parto from patient p "
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
                ...
                + "where pg.voided=0 and ps.voided=0 and p.voided=0 and  pg.program_id=8 and ps.state=27 and ps.end_date is null and  ps.start_date between date_add(:endDate, interval -36 MONTH) and :endDate and location_id=:location) lactante_real on lactante_real.patient_id=carga_viral.patient_id and carga_viral.data_carga>=lactante_real.data_parto and  lactante_real.data_parto between date_add(carga_viral.data_carga, interval -18 MONTH) and carga_viral.data_carga "
                + "where carga_viral.data_carga>=date_add(inicio_real.data_inicio, interval 3 MONTH)  and (lactante_real.data_parto is not null or gravida_real.data_gravida is not null) group by carga_viral.patient_id) cargaGravidaLactante "
    ...
    public static final String
        findBreastfeedingWomanWhoHaveMoreThan3MonthsOnArtWithViralLoadRegisteredInTheLast12Months =
            "select patient_id from ( "
                ...
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
                + "where p.voided=0 and e.voided=0 and o.voided=0 and o.concept_id=1465 and  e.encounter_type=6 and e.encounter_datetime between date_add(:endDate, interval -24 MONTH) and :endDate and e.location_id=:location ) gravida_real on gravida_real.patient_id=carga_viral.patient_id and carga_viral.data_carga>=gravida_real.data_gravida and gravida_real.data_gravida between date_add(carga_viral.data_carga, interval -9 MONTH) and carga_viral.data_carga "
                + "left join( "
                + "Select p.patient_id,o.value_datetime data_parto from patient p "
                + "inner join encounter e on p.patient_id=e.patient_id "
                + "inner join obs o on e.encounter_id=o.encounter_id "
