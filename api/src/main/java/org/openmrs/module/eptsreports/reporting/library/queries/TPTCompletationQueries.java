...
public interface TPTCompletationQueries {
  ...
  class QUERY {
    ...
    public static final String
        findPatientsWhoCompletedTbPrevPreventiveTreatmentDuringReportingPeriod_query1 =
            "select inicio_inh.patient_id from                               "
                + " (     "
                + "       select p.patient_id, o.value_datetime data_inicio_inh              "
                + "             from  patient p     "
    ...
    public static final String
        findPatientsWhoCompletedTbPrevPreventiveTreatmentDuringReportingPeriod_query2 =
    ...
    public static final String
        findPatientsWhoCompletedTbPrevPreventiveTreatmentDuringReportingPeriod_query3 =
            "select inicio_inh.patient_id from              "
                + " (     "
                + "       select p.patient_id, o.value_datetime data_inicio_inh              "
                + "             from  patient p           "
    ...
    public static final String
        findPatientsWhoCompletedTbPrevPreventiveTreatmentDuringReportingPeriod_query4 =
            " select  inicio_inh.patient_id from               "
                + "                 (      "
                + "             select d1.patient_id from  "
                + "( "
    ...
    public static final String
        findPatientsWhoCompletedTbPrevPreventiveTreatmentDuringReportingPeriod_query5 =
            "select inicio_inh.patient_id from             "
                + "(    "
                + "      select p.patient_id, o.value_datetime data_inicio_inh             "
                + "            from  patient p          "
