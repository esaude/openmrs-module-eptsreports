  ...
  class QUERY {
    ...
    public static final String findPatientsInArtWhoAreStable =
        "select patient_id from(select inicio.patient_id, inicio.data_inicio, timestampdiff(year,per.birthdate,:endDate) idade, timestampdiff(month,inicio.data_inicio,:endDate) idadeEmTarv, cd4Absoluto.value_numeric cd4Abs, cd4Percentual.value_numeric cd4Per, cvmenor1000.patient_id pidcv12meses,cvmenor1000.person_id pidcvmenor100 from ( "
            ...
            + "left join (select distinct max_cv.patient_id,o.person_id from ( "
            ...
            + "((o.concept_id=856 and o.value_numeric<1000) or (o.concept_id=1305 and o.value_coded in (1306,23814,23905,23906,23907,23908,23904))) and o.location_id=:location "
            + ") cvmenor1000 "
            + "on "
            + "inicio.patient_id=cvmenor1000.patient_id "
            ...
            + "o.concept_id in (1695,5497) and o.value_numeric>200 and o.location_id=:location) cd4Absoluto on inicio.patient_id=cd4Absoluto.patient_id "
            + "left join ( "
            ...
            + "left join obs o on o.person_id=max_cd4.patient_id and max_cd4.max_data_cd4=o.obs_datetime and o.voided=0 and "
            + "o.concept_id=730 and o.value_numeric>15 and o.location_id=:location) cd4Percentual on inicio.patient_id=cd4Percentual.patient_id) elegivel "
