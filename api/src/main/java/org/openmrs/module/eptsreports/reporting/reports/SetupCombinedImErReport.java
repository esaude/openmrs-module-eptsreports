...
public class SetupCombinedImErReport extends EptsDataExportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		rd.addDataSetDefinition("N", Mapped.mapStraightThrough(this.txNewDataset.constructTxNewDataset()));

		rd.addDataSetDefinition("C", Mapped.mapStraightThrough(this.txCurrDataset.constructTxCurrDataset(true)));

		rd.addDataSetDefinition("ERI2", Mapped.mapStraightThrough(this.eri2MonthsDataset.constructEri2MonthsDatset()));

		rd.addDataSetDefinition("ERI4", Mapped.mapStraightThrough(this.eri4MonthsDataset.constructEri4MonthsDataset()));
	...
	public List<ReportDesign> constructReportDesigns(final ReportDefinition reportDefinition) {
		...
		try {
			reportDesign = this.createXlsReportDesign(reportDefinition, "IM_ER_Report.xls", "ERI-Report",
			        this.getExcelDesignUuid(), null);
