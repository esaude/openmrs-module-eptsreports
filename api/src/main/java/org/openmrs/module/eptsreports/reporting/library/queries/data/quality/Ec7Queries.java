...
public class Ec7Queries {
  ...
  public static String getEc7CombinedQuery(
    ...
    String query = "SELECT  "
    		...
    		+ "f_ec7.dataTransferido location_name FROM ( "
    		...
    		+ "where pe.voided = 0 and (trasferedOut.patient_id is not null) and (trasferedOut.trasfered_date>Seguimento.encounter_datetime ) "
