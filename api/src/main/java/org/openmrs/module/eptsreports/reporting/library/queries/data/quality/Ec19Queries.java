...
public class Ec19Queries {
   ...
   * @return
   */
  public static String getEc19CombinedQuery(int programId, int labEncounterType, int year) {
    String query =
        "SELECT patient_id, NID, Name, birthdate, Estimated_dob, Sex, First_entry_date, Last_updated, date_enrolled,  MIN(encounter_date) AS encounter_date, encounter_date_created, state, location_name FROM("
