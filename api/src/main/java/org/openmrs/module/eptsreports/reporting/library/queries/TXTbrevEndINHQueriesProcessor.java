...
public interface TXTbrevEndINHQueriesProcessor {
  ...
  class QUERY {
    ...
    public static final String findMaxEncounterDateByPatientMin6Encounters =
    ...
    public static final String findMaxEncounterDateByPatientMin2FlitsEncounters =
    ...
    public static final String findMaxEncounterDateByPatientMin6FlitsEncounters =
    ...
    public static final String findMaxEncounterDateByPatientMin2Encounters =
