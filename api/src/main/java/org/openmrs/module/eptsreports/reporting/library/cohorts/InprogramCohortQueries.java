...
@Component
public class InprogramCohortQueries {
	...
	public InProgramCohortDefinition createInProgramParameterizableByDateAndLocation(String name, Program programs, List<String> parameterName, String location) {
