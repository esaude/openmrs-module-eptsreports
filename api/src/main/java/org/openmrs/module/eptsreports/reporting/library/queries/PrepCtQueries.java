  ...
  class QUERY {
    ...
    public static final String findClientsWithPregnancyStatusDuringReportingPeriod =
        "select patient_id from( "
            ...
            + "if(gravida.data_gravida is null,null, "
            + "if(lactante.data_lactante is null,null, "
            + "if(gravida.data_gravida>lactante.data_lactante,1, "
            + "if(gravida.data_gravida<lactante.data_lactante,2, "
            + "if(lactante.data_lactante=gravida.data_gravida,1,null)))))) decisao "
            + " from (select * from ( "
            + "select * from ( "
