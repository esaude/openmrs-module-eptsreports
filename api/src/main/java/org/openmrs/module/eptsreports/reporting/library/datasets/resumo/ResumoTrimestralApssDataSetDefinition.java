...
public class ResumoTrimestralApssDataSetDefinition extends BaseDataSet {
	...
	@Autowired
	public ResumoTrimestralApssDataSetDefinition(EptsCommonDimension eptsCommonDimension,
	...
	public DataSetDefinition constructResumoTrimestralApssDataset() {
		...
		dsd.addDimension("age", map(eptsCommonDimension.age(ageDimensionCohort), "effectiveDate=${endDate}"));

		addRow(dsd, "A1Under15", "A1 - Patients Between 8  and 14 years", getIndicatorA1(),
				resumoTrimestralAgeAndGenderDisaggregations.get8To14YearsColumns());

		addRow(dsd, "B1Under15", "B1 - Patients under 15 years",
		...
		addRow(dsd, "B1Over15", "B1 - Patients over 15 years",
				getPatientsWhoInitiatedTarvAtThisFacilityDuringCurrentMonthB1(),
				resumoTrimestralAgeAndGenderDisaggregations.getAdultPatients());

		dsd.addColumn("B1Total", "B1 - Total patients - Total Geral",
				getPatientsWhoInitiatedTarvAtThisFacilityDuringCurrentMonthB1(), "");

		addRow(dsd, "C1Under15", "C1 - Patients under 15 years", getPatientsWhoAreCurrentlyEnrolledOnARTC1(),
				resumoTrimestralAgeAndGenderDisaggregations.getUnder14YearsColumns());

		addRow(dsd, "C1Over15", "C1 - Patients over 15 years - adults", getPatientsWhoAreCurrentlyEnrolledOnARTC1(),
				resumoTrimestralAgeAndGenderDisaggregations.getAdultPatients());

		dsd.addColumn("C1Total", "C1 - Total patients - Total Geral", getPatientsWhoAreCurrentlyEnrolledOnARTC1(), "");

		addRow(dsd, "D1Over15", " D1 - Patients over 15 years - adults",
				getPatientsWhoInitiatedPreTarvAtAfacilityDuringCurrentMonthD1(),
				resumoTrimestralAgeAndGenderDisaggregations.getAdultPatients());

		dsd.addColumn("D1Total", "D1 - Total patients - Total Geral",
				getPatientsWhoInitiatedPreTarvAtAfacilityDuringCurrentMonthD1(), "age=15+");
	...
	private Mapped<CohortIndicator> getIndicatorA1() {
		return mapStraightThrough(
				eptsGeneralIndicator.getIndicator("A1", mapStraightThrough(this.resumoMensalAPSSCohortQueries
	...
	private Mapped<CohortIndicator> getPatientsWhoInitiatedPreTarvAtAfacilityDuringCurrentMonthD1() {
		return mapStraightThrough(eptsGeneralIndicator.getIndicator("D1", mapStraightThrough(
				resumoMensalAPSSCohortQueries.findPatientsWhoAreCurrentlyEnrolledOnArtWithPrevencaoPosetivaD1())));
	}

	private Mapped<CohortIndicator> getPatientsWhoInitiatedTarvAtThisFacilityDuringCurrentMonthB1() {
		return mapStraightThrough(eptsGeneralIndicator.getIndicator("B1", mapStraightThrough(
				resumoMensalAPSSCohortQueries.getPatientsWhoInitiatedPreTarvAtAfacilityDuringCurrentMonthB1())));
	}

	private Mapped<CohortIndicator> getPatientsWhoAreCurrentlyEnrolledOnARTC1() {
		return mapStraightThrough(eptsGeneralIndicator.getIndicator("C1",
				mapStraightThrough(resumoMensalAPSSCohortQueries.findPatientsWhoAreCurrentlyEnrolledOnArtMOHC1())));
	}
}
