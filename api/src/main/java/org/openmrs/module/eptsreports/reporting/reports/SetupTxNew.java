...
public class SetupTxNew extends EptsDataExportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		reportDefinition.addDataSetDefinition(txNewDataset.constructTxNewDatset(), ParameterizableUtil.createParameterMappings("endDate=${endDate},startDate=${startDate},location=${location}"));
