...
public class HivMetadata extends ProgramsMetadata {
	...
	private final String gpSTarvFarmaciaEncounterTypeUuid = "eptsreports.sTarvFarmaciaEncounterTypeUuid";
	...
	public Concept getHivViralLoadConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.hivViralLoadConceptUuid");
		return getConcept(uuid);
	}

	public Concept getCriteriaForArtStart() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.criteriaForArtStartUuid");
		return getConcept(uuid);
	}

	// concept_id=5096
	public Concept getReturnVisitDateForArvDrugConcept() {
		final String uuid = Context.getAdministrationService()
	...
	public Concept getDateOfHivDiagnosisConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.dateOfHIVDiagnosis");
		return getConcept(uuid);
	}
	...
	public Concept getARVPlanConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.arvPlanConceptUuid");
		return getConcept(uuid);
	}

	// concept_id=1088
	public Concept getRegimeConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.regimeUuid");
		return getConcept(uuid);
	}

	public Concept getRestartConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.restartConceptUuid");
		return getConcept(uuid);
	}

	// concept_id = 1707
	public Concept getAbandoned() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.abandonedConceptUuid");
		return getConcept(uuid);
	}
	...
	public Concept getAztDdiLpvConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.AZT_DDI_LPV_ConceptUuid");
		return getConcept(uuid);
	}

	// 1315
	public Concept getTdf3tcEfvConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.TDF_3TC_EFV_ConceptUuid");
		return getConcept(uuid);
	}

	// 1314
	public Concept getAzt3tcLpvConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.AZT_3TC_LPV_ConceptUuid");
		return getConcept(uuid);
	}

	// 1313
	public Concept getAbc3tcEfvConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.ABC_3TC_EFV_ConceptUuid");
		return getConcept(uuid);
	}

	// 1312
	public Concept getAbc3tcNvpConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.ABC_3TC_NVP_ConceptUuid");
		return getConcept(uuid);
	}

	// 1311
	public Concept getAbc3tcLpvConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.ABC_3TC_LPV_ConceptUuid");
		return getConcept(uuid);
	}

	//
	public Concept getTdf3tcLpvConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.TDF_3TC_LPV_ConceptUuid");
		return getConcept(uuid);
	}
	...
	public Concept getNoConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.noConceptUuid");
		return getConcept(uuid);
	}
	...
	public Concept getIsoniazidUsageConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.isoniazidUseConceptUuid");
		return getConcept(uuid);
	}

	// concept_id=1695
	public Concept getCD4AbsoluteOBSConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.cd4AbsoluteOBSUuid");
		return getConcept(uuid);
	}
	...
	public Concept getcurrentWhoHivStageConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.currentWhoHivStageUuid");
		return getConcept(uuid);
	}

	// concept_id=1205
	public Concept getWho2AdultStageConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.who2AdultStageUuid");
		return getConcept(uuid);
	}

	// concept_id=1206
	public Concept getWho3AdultStageConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.who3AdultStageUuid");
		return getConcept(uuid);
	}

	// concept_id=1207
	public Concept getWho4AdultStageConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.who4AdultStageUuid");
		return getConcept(uuid);
	}
	...
	public Concept getTypeOfVisitConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.typeOfVisit");
		return getConcept(uuid);
	}

	// concept_id = 2003
	public Concept getPatientFoundConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.patientFound");
		return getConcept(uuid);
	}

	// concept_id = 1065
	public Concept getPatientFoundYesConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.yesConceptUuid");
		return getConcept(uuid);
	}
	...
	public Concept getSecondAttemptConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.secondAttempt");
		return getConcept(uuid);
	}

	// concept_id = 6255
	public Concept getThirdAttemptConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.thirdAttempt");
		return getConcept(uuid);
	}

	// concept_id = 2016
	public Concept getDefaultingMotiveConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.defaultingMotive");
		return getConcept(uuid);
	}

	// concept_id = 2158
	public Concept getReportOfVisitSupportConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.reportOfVisitSupport");
		return getConcept(uuid);
	}

	// concept_id = 2157
	public Concept getPatientHadDifficultyConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.patientHadDifficulty");
		return getConcept(uuid);
	}

	// concept_id = 1272
	public Concept getPatientFoundForwardedConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.patientFoundForwarded");
		return getConcept(uuid);
	}

	// concept_id = 2037
	public Concept getWhoGaveInformationConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.whoGaveInformation");
		return getConcept(uuid);
	}

	// concept_id = 2180
	public Concept getCardDeliveryDateConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.cardDeliveryDate");
		return getConcept(uuid);
	}
	...
	private Concept getActiveOnProgramConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.activeOnProgramConcept");
		return getConcept(uuid);
	}
	...
	public Concept getNormalConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.normalConcept");
		return getConcept(uuid);
	}

	// concept_id = 1116
	public Concept getAbnormalConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.abnormalConcept");
		return getConcept(uuid);
	}

	// concept_id = 1399
	public Concept getSecretionsConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.secretionsConcept");
		return getConcept(uuid);
	}

	// concept_id = 1400
	public Concept getCondylomasConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.condylomasConcept");
		return getConcept(uuid);
	}

	// concept_id = 1602
	public Concept getUlcersConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.ulcersConcept");
		return getConcept(uuid);
	}

	// concept_id=5488
	public Concept getAdherenceCoucelingConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.adherenceCounselingUuid");
		return getConcept(uuid);
	}

	// concept_id=5497
	public Concept getCD4AbsoluteConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.cd4AbsolutoUuid");
		return getConcept(uuid);
	}

	// concept_id=730
	public Concept getCD4PercentConcept() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.cd4PercentUuid");
		return getConcept(uuid);
	}

	// concept_id=1714
	public Concept getAdherence() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.poorAdherenceUuid");
		return getConcept(uuid);
	}

	// concept_id=2015
	public Concept getAdverseReaction() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.adverseReactionUuid");
		return getConcept(uuid);
	}

	// Concept 6292
	public Concept getNeutropenia() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.neutropenia");
		return getConcept(uuid);
	}

	// Concept 6293
	public Concept getPancreatitis() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.pancreatitis");
		return getConcept(uuid);
	}

	// Concept 6294
	public Concept getHepatotoxicity() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.hepatotoxicity");
		return getConcept(uuid);
	}

	// Concept 6295
	public Concept getPsychologicalChanges() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.psychologicalChanges");
		return getConcept(uuid);
	}

	// Concept 6296
	public Concept getMyopathy() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.myopathy");
		return getConcept(uuid);
	}

	// Concept 6297
	public Concept getSkinAllergy() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.skinAllergy");
		return getConcept(uuid);
	}

	// Concept 6298
	public Concept getLipodystrophy() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.lipodystrophy");
		return getConcept(uuid);
	}

	// Concept 6299
	public Concept getLacticAcidosis() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.lacticAcidosis");
		return getConcept(uuid);
	}

	// Concept 821
	public Concept getPeripheralNeuropathy() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.peripheralNeuropathy");
		return getConcept(uuid);
	}

	// Concept 16
	public Concept getDiarrhea() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.diarrhea");
		return getConcept(uuid);
	}

	// Concept 1406
	public Concept getOtherDiagnosis() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.otherDiagnosis");
		return getConcept(uuid);
	}
	...
	public Concept getFamilyApproach() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.familyApproach");
		return getConcept(uuid);
	}

	// Concept 23726 CA
	public Concept getAccessionClubs() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.accessionClubs");
		return getConcept(uuid);
	}

	// Concept 23727 PU
	public Concept getSingleStop() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.singleStop");
		return getConcept(uuid);
	}

	// Concept 23729 FR
	public Concept getRapidFlow() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.rapidFlow");
		return getConcept(uuid);
	}

	// Concept 23730 DT
	public Concept getQuarterlyDispensation() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.quarterlyDispensation");
		return getConcept(uuid);
	}

	// Concept 23731 DC
	public Concept getCommunityDispensation() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.communityDispensation");
		return getConcept(uuid);
	}

	// Concept 23732 Other Model
	public Concept getAnotherModel() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.anotherModel");
		return getConcept(uuid);
	}

	// Concept 1256 Start Drugs
	public Concept getStartDrugs() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.startDrugs");
		return getConcept(uuid);
	}

	// Concept 1257 Continue Regimen
	public Concept getContinueRegimen() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.continueRegimen");
		return getConcept(uuid);
	}

	// Concept 23808 Pre-ART Start Date
	public Concept getPreArtStartDate() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.preArtStartDate");
		return getConcept(uuid);
	}

	// Concept 23866 Date of ART Pickup
	public Concept getArtDatePickup() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.preArtPickupDate");
		return getConcept(uuid);
	}
	...
	public Concept getStateOfStayOfArtPatient() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.stateOfStayArtPatient");
		return getConcept(uuid);
	}

	// Concept 2031 REASON PATIENT NOT FOUND BY ACTIVIST
	public Concept getReasonPatientNotFound() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.reasonPatientNotFound");
		return getConcept(uuid);
	}

	// Concept 2027 PATIENT IS DEAD
	public Concept getPatientIsDead() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.patientIsdead");
		return getConcept(uuid);
	}
	...
	public EncounterType getARVPharmaciaEncounterType() {
		final String uuid = Context.getAdministrationService().getGlobalProperty(this.gpSTarvFarmaciaEncounterTypeUuid);
		return getEncounterType(uuid);
	}
	...
	public EncounterType getMasterCardEncounterType() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.masterCardEncounterType");
		return getEncounterType(uuid);
	}
	// Programs
	...
	public Program getPtvEtvProgram() {
		final String uuid = Context.getAdministrationService().getGlobalProperty(this.gpPtvEtvProgramUuid);
		return getProgram(uuid);
	}

	// program_id=1
	public Program getHIVCareProgram() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.hivCareProgramUuid");
		return getProgram(uuid);
	}

	// Identifier types
	public PatientIdentifierType getNidServiceTarvIdentifierType() {
		final String uuid = Context.getAdministrationService().getGlobalProperty("eptsreports.nidServicoTarvUuid");
	...
	public ProgramWorkflowState getTransferredOutToAnotherHealthFacilityWorkflowState() {
		final String artProgramUuid = Context.getAdministrationService().getGlobalProperty(this.gpArtProgramUuid);
	...
	public ProgramWorkflowState getTransferredFromOtherHealthFacilityWorkflowState() {
		...
		// ProgramWorkflow)
		final String artProgramUuid = Context.getAdministrationService().getGlobalProperty(this.gpArtProgramUuid);
		final String transferFromOtherUuid = Context.getAdministrationService()
	...
	public ProgramWorkflowState getArtCareTransferredFromOtherHealthFacilityWorkflowState() {
		...
		final ProgramWorkflowState state = this.getTransferredFromOtherHealthFacilityWorkflowState(hivCareProgram,
		        workflow);
		return state;
	}
	...
	public ProgramWorkflowState getArtCareTransferredOutToAnotherHealthFacilityWorkflowState() {
		final Program hivCareProgram = this.getHIVCareProgram();
		final ProgramWorkflow workflow = this.getPreArtWorkflow();
		final ProgramWorkflowState state = this.getTransferredOutToAnotherHealthFacilityWorkflowState(hivCareProgram,
		        workflow);
		return state;
	}
	...
	public ProgramWorkflowState getArtCareActiveOnProgramWorkflowState() {
		final Program hivCareProgram = this.getHIVCareProgram();
		final ProgramWorkflow workflow = this.getPreArtWorkflow();
		final ProgramWorkflowState state = this.getActiveOnProgramWorkflowState(hivCareProgram, workflow);
		return state;
	}
	...
	public ProgramWorkflowState getPatientIsBreastfeedingWorkflowState() {
		final String ptvProgramUuid = Context.getAdministrationService().getGlobalProperty(this.gpPtvEtvProgramUuid);
	...
	public ProgramWorkflowState getPateintActiveOnHIVCareProgramtWorkflowState() {
		final String hivCareProgramUuid = Context.getAdministrationService()
		        .getGlobalProperty("eptsreports.hivCareProgramUuid");
	...
	private ProgramWorkflowState getActiveOnProgramWorkflowState(final Program program,
	        final ProgramWorkflow programWorkflow) {
	...
	private ProgramWorkflowState getAbandonedWorkflowState(final Program program,
	        final ProgramWorkflow programWorkflow) {
	...
	private ProgramWorkflowState getDeadWorkflowState(final Program program, final ProgramWorkflow programWorkflow) {
	...
	private ProgramWorkflowState getTransferredOutToAnotherHealthFacilityWorkflowState(final Program program,
	        final ProgramWorkflow programWorkflow) {
	...
	private ProgramWorkflowState getTransferredFromOtherHealthFacilityWorkflowState(final Program program,
	        final ProgramWorkflow programWorkflow) {
		final Concept transferFromOtherFacility = this.getTransferFromOtherFacilityConcept();
		return getProgramWorkflowState(program.getUuid(), programWorkflow.getUuid(),
		        transferFromOtherFacility.getUuid());
	}
	...
	public ProgramWorkflowState getArtTransferredOutToAnotherHealthFacilityWorkflowState() {
		final Program artProgram = this.getARTProgram();
		final ProgramWorkflow workflow = this.getArtWorkflow();
		final ProgramWorkflowState state = this.getTransferredOutToAnotherHealthFacilityWorkflowState(artProgram,
		        workflow);
		return state;
	}
