...
public class Ec2Queries {
  ...
  public static String getEc2CombinedQuery(
    ...
    String query =
        "SELECT patient_id, NID, Name, birthdate, estimated_dob, Sex, first_entry_date, last_updated, criteria, encounter_date, date_enrolled, state, breastfeeding.location_name FROM("
