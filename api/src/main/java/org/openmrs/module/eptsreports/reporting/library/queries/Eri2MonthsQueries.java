...
public class Eri2MonthsQueries {
	 ...
	 * @return
	 */
	public static String getAllPatientsWhoReturnedFor2ndConsultationOR2ndDrugsPickUpWithin33Days(int arvPharmaciaEncounter,
		...
		return "SELECT inicio_real.patient_id " + "FROM " + "(SELECT patient_id,data_inicio " + "FROM "
		        ...
		        + "GROUP BY inicio_real.patient_id " + "HAVING MIN(e.encounter_datetime) < MAX(e.encounter_datetime)";
	}
