...
import org.openmrs.module.eptsreports.reporting.calculation.melhoriaQualidade.MohMqInitiatedArtCalculation;
...
@Component
public class AgeOnMohMqArtStartDateCalculation extends AbstractPatientCalculation {
  ...
  public CalculationResultMap evaluate(
    ...
    CalculationResultMap artStartDates =
        calculate(
            Context.getRegisteredComponents(MohMqInitiatedArtCalculation.class).get(0),
            cohort,
            context);
