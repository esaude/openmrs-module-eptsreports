...
public class SetupPepfarEarlyRetentionIndicatorsReport extends EptsDataExportManager {
    ...
    public ReportDefinition constructReportDefinition() {
        ...
        rd.addDataSetDefinition("Pepfar early retention Data Set", Mapped.mapStraightThrough(pepfarEarlyRetentionDataset.constructPepfarEarlyRetentionDatset()));
    ...
    public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
        ...
        try {
            reportDesign = createXlsReportDesign(reportDefinition, "PEPFAR_Early_Retention.xls", "PEPFAR_Early_Retention_Indicators", getExcelDesignUuid(), null);
