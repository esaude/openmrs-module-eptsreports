...
public class TxCurrCohortQueries {
	...
	public CohortDefinition getPatientsOnArtOnArvDispenseForLessThan3Months() {
		...
		cd.addSearch("patientsWhoAreActiveOnART", EptsReportUtils.map(this.findPatientsWhoAreActiveOnART(), mapping));
		cd.addSearch("arvDispenseForLessThan3Months",
				EptsReportUtils.map(this.getPatientsOnArtOnArvDispenseForLessThan3MonthsCalculation(), mapping));
	...
	public CohortDefinition getPatientsOnArtOnArvDispenseBetween3And5Months() {
		...
		String mapping = "endDate=${endDate},location=${location}";
		cd.addSearch("patientsWhoAreActiveOnART", EptsReportUtils.map(this.findPatientsWhoAreActiveOnART(), mapping));
		cd.addSearch("arvDispenseBetween3And5Months",
				EptsReportUtils.map(this.getPatientsOnArtOnArvDispenseBetween3And5MonthsCalculation(), mapping));
	...
	public CohortDefinition getPatientsOnArtOnArvDispenseFor6OrMoreMonths() {
		...
		String mapping = "endDate=${endDate},location=${location}";
		cd.addSearch("patientsWhoAreActiveOnART", EptsReportUtils.map(this.findPatientsWhoAreActiveOnART(), mapping));
		cd.addSearch("arvDispenseFor6OrMoreMonths",
				EptsReportUtils.map(this.getPatientsOnArtOnArvDispenseFor6OrMoreMonthsCalculation(), mapping));
	...
	private CohortDefinition getPatientsOnArtOnArvDispenseForLessThan3MonthsCalculation() {
		BaseFghCalculationCohortDefinition cd = new BaseFghCalculationCohortDefinition(
				...
				Context.getRegisteredComponents(TxCurrPatientsOnArvDispenseLessThan3MonthCalculation.class).get(0));
	...
	private CohortDefinition getPatientsOnArtOnArvDispenseBetween3And5MonthsCalculation() {
		BaseFghCalculationCohortDefinition cd = new BaseFghCalculationCohortDefinition(
				...
				Context.getRegisteredComponents(TxCurrPatientsOnArvDispenseBetween3And5MonthsCalculation.class).get(0));
	...
	private CohortDefinition getPatientsOnArtOnArvDispenseFor6OrMoreMonthsCalculation() {
		BaseFghCalculationCohortDefinition cd = new BaseFghCalculationCohortDefinition(
				...
				Context.getRegisteredComponents(TxCurrPatientsOnArvDispense6OrMoreMonthsCalculation.class).get(0));
		cd.addParameter(new Parameter("endDate", "end Date", Date.class));
		cd.addParameter(new Parameter("location", "Location", Location.class));
