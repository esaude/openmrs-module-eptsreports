...
public class TxCurrCohortQueries {
    ...
    public CohortDefinition getPatientWithFirstDrugPickupEncounterBeforeOrOnEndDate() {
        ...
        patientWithFirstDrugPickupEncounter.setQuery("select p.patient_id FROM patient p "
    ...
    public CohortDefinition getTxCurrCompositionCohort(String cohortName, CohortDefinition inARTProgramAtEndDate,
        ...
        TxCurrComposition
                        .getSearches().put("7",
                                        new Mapped<CohortDefinition>(patientsThatDidNotMissNextConsultation,
                                                        ParameterizableUtil.createParameterMappings(String.format(
                                                                        "onOrBefore=${onOrBefore},location=${location},abandonmentDays=%s",
                                                                        abandonmentDays))));
        TxCurrComposition
                        .getSearches().put("8",
                                        new Mapped<CohortDefinition>(patientsReportedAsAbandonmentButStillInPeriod,
                                                        ParameterizableUtil.createParameterMappings(String.format(
                                                                        "onOrBefore=${onOrBefore},location=${location},abandonmentDays=%s",
                                                                        abandonmentDays))));
