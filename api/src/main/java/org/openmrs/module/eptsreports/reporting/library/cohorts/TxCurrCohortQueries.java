...
public class TxCurrCohortQueries {
	...
	public SqlCohortDefinition getPatientsWhoHaveNotReturned() {
		...
		patientsWhoHaveNotReturned.setQuery(String.format(query, hivMetadata.getARVPharmaciaEncounterType()
	...
	public SqlCohortDefinition getPatientsWhoHaveNotCompleted60Days() {
		...
		patientsWhoHaveNotCompleted60Days.setQuery("select patient_id from "
	...
	public CohortDefinition getTxCurrCompositionCohort(String cohortName, CohortDefinition inARTProgramAtEndDate,
		...
		TxCurrComposition.getSearches().put(
		    "6",
		    new Mapped<CohortDefinition>(patientsWhoHaveNotReturned, ParameterizableUtil
		            .createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		TxCurrComposition.getSearches().put(
		    "7",
		    new Mapped<CohortDefinition>(patientsWhoHaveNotCompleted60Days, ParameterizableUtil
		            .createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		TxCurrComposition.getSearches().put(
		    "8",
		    new Mapped<CohortDefinition>(abandonedButHaveNotcompleted60Days, ParameterizableUtil
		            .createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
