...
@Component
public class TxMLPatientsWhoAreLTFUGreatherThan6MonthsCalculation extends TxMLPatientCalculation {
  ...
  protected CalculationResultMap evaluateUsingCalculationRules(
    ...
    for (Integer patientId : cohort) {
      ...
      if (maxNextDate != null
          && EptsDateUtil.getDaysBetween(inicioRealDate, maxNextDate) >= GREATHER_THAN_6_MONTHS) {
