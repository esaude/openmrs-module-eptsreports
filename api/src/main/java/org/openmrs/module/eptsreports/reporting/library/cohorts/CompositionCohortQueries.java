...
public class CompositionCohortQueries {
	...
	// TxNew
	// If Gender = null then Male & Female combined
	...
	public CompositionCohortDefinition getPatientBellowOneYearCurrentlyInARTStarted(CohortDefinition inARTProgramAtEndDate,
	        ...
	        CohortDefinition abandonedButHaveNotcompleted60Days, CohortDefinition ageCohort) {
		...
		patientBellowOneYearCurrentlyInARTStarted.getSearches().put("1", new Mapped<CohortDefinition>(inARTProgramAtEndDate,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBellowOneYearCurrentlyInARTStarted.getSearches().put("2", new Mapped<CohortDefinition>(patientWithSTARTDRUGSObs,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBellowOneYearCurrentlyInARTStarted.getSearches().put("3",
		    new Mapped<CohortDefinition>(patientWithHistoricalDrugStartDateObs,
		            ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBellowOneYearCurrentlyInARTStarted.getSearches().put("4", new Mapped<CohortDefinition>(patientsWithDrugPickUpEncounters,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBellowOneYearCurrentlyInARTStarted.getSearches().put("5",
		    new Mapped<CohortDefinition>(patientsWhoLeftARTProgramBeforeOrOnEndDate,
		            ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBellowOneYearCurrentlyInARTStarted.getSearches().put("6", new Mapped<CohortDefinition>(patientsWhoHaveNotReturned,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBellowOneYearCurrentlyInARTStarted.getSearches().put("7",
		    new Mapped<CohortDefinition>(patientsWhoHaveNotCompleted60Days,
		            ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBellowOneYearCurrentlyInARTStarted.getSearches().put("8",
		    new Mapped<CohortDefinition>(abandonedButHaveNotcompleted60Days,
		            ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		
		// TODO -Check specifications document on how to use query 6,7 and 8
		patientBellowOneYearCurrentlyInARTStarted.getSearches().put("9",
		    new Mapped<CohortDefinition>(ageCohort, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
		patientBellowOneYearCurrentlyInARTStarted
		        .setCompositionString("((1 AND 2 AND 3 AND 4) AND (NOT 5) AND NOT ( 6 NOT (5 OR 7 OR 8))) AND 9");
		return patientBellowOneYearCurrentlyInARTStarted;
	}
	
	@DocumentedDefinition(value = "patientBetween1And9YearsCurrently")
	public CompositionCohortDefinition getPatientBetween1And9YearsCurrently(CohortDefinition inARTProgramAtendDate,
	        CohortDefinition patientWithSTARTDRUGSObs, CohortDefinition patientWithHistoricalDrugStartDateObs,
	        CohortDefinition patientsWithDrugPickUpEncounters, CohortDefinition patientsWhoLeftARTProgramBeforeOrOnEndDate,
	        CohortDefinition patientsWhoHaveNotReturned, CohortDefinition patientsWhoHaveNotCompleted60Days,
	        CohortDefinition abandonedButHaveNotcompleted60Days, CohortDefinition ageCohort) {
		...
		patientBetween1And9YearsCurrently.getSearches().put("1", new Mapped<CohortDefinition>(inARTProgramAtendDate,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBetween1And9YearsCurrently.getSearches().put("2", new Mapped<CohortDefinition>(patientWithSTARTDRUGSObs,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBetween1And9YearsCurrently.getSearches().put("3", new Mapped<CohortDefinition>(patientWithHistoricalDrugStartDateObs,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBetween1And9YearsCurrently.getSearches().put("4", new Mapped<CohortDefinition>(patientsWithDrugPickUpEncounters,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBetween1And9YearsCurrently.getSearches().put("5",
		    new Mapped<CohortDefinition>(patientsWhoLeftARTProgramBeforeOrOnEndDate,
		            ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBetween1And9YearsCurrently.getSearches().put("6", new Mapped<CohortDefinition>(patientsWhoHaveNotReturned,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBetween1And9YearsCurrently.getSearches().put("7", new Mapped<CohortDefinition>(patientsWhoHaveNotCompleted60Days,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientBetween1And9YearsCurrently.getSearches().put("8", new Mapped<CohortDefinition>(abandonedButHaveNotcompleted60Days,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		
		// TODO -Check specifications document on how to use query 6,7 and 8
		patientBetween1And9YearsCurrently.getSearches().put("9",
		    new Mapped<CohortDefinition>(ageCohort, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
		patientBetween1And9YearsCurrently
		        .setCompositionString("((1 AND 2 AND 3 AND 4) AND (NOT 5) AND NOT (6 NOT (5 OR 7 OR 8))) AND 9");
	...
	public CompositionCohortDefinition getPatientInYearRangeCurrentlyInARTStarted(CohortDefinition inARTProgramAtEndDate,
	        ...
	        CohortDefinition patientsWithDrugPickUpEncounters, CohortDefinition patientsWhoLeftARTProgramBeforeOrOnEndDate,
	        CohortDefinition patientsWhoHaveNotReturned, CohortDefinition patientsWhoHaveNotCompleted60Days,
	        CohortDefinition abandonedButHaveNotcompleted60Days, CohortDefinition PatientBetween1And9Years, CohortDefinition ageCohort,
	        CohortDefinition gender) {
		...
		patientInYearRangeEnrolledInARTStarted.getSearches().put("1", new Mapped<CohortDefinition>(inARTProgramAtEndDate,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		...
		patientInYearRangeEnrolledInARTStarted.getSearches().put("3",
		    new Mapped<CohortDefinition>(patientWithHistoricalDrugStartDateObs,
		            ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientInYearRangeEnrolledInARTStarted.getSearches().put("4", new Mapped<CohortDefinition>(patientsWithDrugPickUpEncounters,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientInYearRangeEnrolledInARTStarted.getSearches().put("5",
		    new Mapped<CohortDefinition>(patientsWhoLeftARTProgramBeforeOrOnEndDate,
		            ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientInYearRangeEnrolledInARTStarted.getSearches().put("6", new Mapped<CohortDefinition>(patientsWhoHaveNotReturned,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientInYearRangeEnrolledInARTStarted.getSearches().put("7", new Mapped<CohortDefinition>(patientsWhoHaveNotCompleted60Days,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientInYearRangeEnrolledInARTStarted.getSearches().put("8", new Mapped<CohortDefinition>(abandonedButHaveNotcompleted60Days,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		
		// TODO -Check specifications document on how to use query 6,7 and 8
		patientInYearRangeEnrolledInARTStarted.getSearches().put("9",
		    new Mapped<CohortDefinition>(ageCohort, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
		...
		patientInYearRangeEnrolledInARTStarted
		        .setCompositionString("((1 AND 2 AND 3 AND 4) AND (NOT 5) AND NOT (6 NOT (5 OR 7 OR 8))) AND 9 AND 10");
	...
	public CompositionCohortDefinition getAllPatientsCurrentlyInARTStarted(CohortDefinition inARTProgramAtEndDate,
	        ...
	        CohortDefinition patientsWithDrugPickUpEncounters, CohortDefinition patientsWhoLeftARTProgramBeforeOrOnEndDate,
	        CohortDefinition patientsWhoHaveNotReturned, CohortDefinition patientsWhoHaveNotCompleted60Days,
	        CohortDefinition abandonedButHaveNotcompleted60Days) {
		...
		patientsCurrentlyInARTStarted.getSearches().put("1", new Mapped<CohortDefinition>(inARTProgramAtEndDate,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientsCurrentlyInARTStarted.getSearches().put("2", new Mapped<CohortDefinition>(patientWithSTARTDRUGSObs,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientsCurrentlyInARTStarted.getSearches().put("3", new Mapped<CohortDefinition>(patientWithHistoricalDrugStartDateObs,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientsCurrentlyInARTStarted.getSearches().put("4", new Mapped<CohortDefinition>(patientsWithDrugPickUpEncounters,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientsCurrentlyInARTStarted.getSearches().put("5", new Mapped<CohortDefinition>(patientsWhoLeftARTProgramBeforeOrOnEndDate,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientsCurrentlyInARTStarted.getSearches().put("6", new Mapped<CohortDefinition>(patientsWhoHaveNotReturned,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientsCurrentlyInARTStarted.getSearches().put("7", new Mapped<CohortDefinition>(patientsWhoHaveNotCompleted60Days,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
		patientsCurrentlyInARTStarted.getSearches().put("8", new Mapped<CohortDefinition>(abandonedButHaveNotcompleted60Days,
		        ParameterizableUtil.createParameterMappings("onOrBefore=${onOrBefore},location=${location}")));
