...
public interface TxRttQueries {
	...
	class QUERY {
		...
		public static final String findPatientsWithEncountersInASpecificPeriod = "SELECT p.patient_id FROM patient p "
		...
		public static final String findEncountersByPatient = "SELECT encounters.patient_id, encounters.encounter_datetime FROM ("
		...
		public static final String findLastNextPickupDateOnThePreviousPickupEncounterByPatient = "SELECT value_datetime FROM ( "
		...
		public static final String findLastNextEncounterScheduledDateOnThePreviousFolloupEncounterByPatient = "SELECT o.value_datetime FROM ( "
		        + "SELECT p.patient_id, MAX(e.encounter_datetime) encounter_datetime FROM patient p "
		        + "INNER JOIN encounter e ON e.patient_id = p.patient_id "
		        + "INNER JOIN obs o ON o.encounter_id = e.encounter_id "
