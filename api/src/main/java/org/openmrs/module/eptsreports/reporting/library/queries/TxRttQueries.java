...
public class TxRttQueries {
  ...
  /**
   * Check each encounter against the previous scheduled date of drug pickup AND consultations to be greater than 28 days.
   * Pick any of the encounters which occurred 28 dyas after the previously scheduled consultation or drug pickup.
   * 
