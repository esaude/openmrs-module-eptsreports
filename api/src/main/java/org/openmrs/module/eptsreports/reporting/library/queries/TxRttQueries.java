    ...
    public static final String
        findLastNextEncounterScheduledDateOnThePreviousFolloupEncounterByPatient =
            "SELECT max(o.value_datetime) value_datetime FROM ( "
                ...
                + "GROUP BY p.patient_id "
                + ") max_encounter "
                + "INNER JOIN obs o ON max_encounter.patient_id = o.person_id "
                + "AND o.concept_id = 1410 AND o.voided = 0 AND max_encounter.encounter_datetime = o.obs_datetime AND o.value_datetime IS NOT NULL "
                + "GROUP BY max_encounter.patient_id ";
  }
}
