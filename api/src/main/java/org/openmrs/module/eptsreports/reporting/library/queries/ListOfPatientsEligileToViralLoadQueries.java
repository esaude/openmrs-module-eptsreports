  ...
  class QUERY {
    ...
    public static final String findPatientsEligibleToViralLoadList =
        "	select inicio.patient_id, inicio.data_inicio, "
            ...
            + "	carga_viral.data_carga, carga_viral.valor_carga, "
            + "case regime_tarv "
            ...
            + "where pe.voided=0 and p.voided=0 and pp.location_id = 278 and pp.voided = 0 and pp.program_id = 2 "
            ...
            + "where (data_estado is null or (data_estado is not null and  data_usar_c>data_estado)) and date_add(data_usar, interval 30 day) >=:endDate "
            ...
            + "inner join "
            + "( "
            + "select levantamento_consulta.patient_id, carga_viral.data_carga,valor_carga  from ( "
            + "select patient_id,max(data_levantamento) data_levantamento from ( "
            ...
            + "union "
            + "Select p.patient_id,max(value_datetime) data_levantamento from 	patient p "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=52 and  o.concept_id=23866 and o.value_datetime is not null and  o.value_datetime<=:endDate and e.location_id=:location group by p.patient_id) inicio group by patient_id) levantamento_consulta "
            + "inner join ( "
            ...
            + "where obs.voided=0 and ((obs.concept_id=856 and obs.value_numeric<1000) or (obs.concept_id=1305 and obs.value_coded in (1306,23814,23905,23906,23907,23908,23904)))  and obs.location_id=:location) carga_viral on levantamento_consulta.patient_id=carga_viral.patient_id "
            + "where carga_viral.data_carga<=date_sub(levantamento_consulta.data_levantamento, interval 12 MONTH) "
            + "union "
            + " select levantamento_consulta.patient_id, carga_viral.data_carga, carga_viral.valor_carga  from ( "
            + "select patient_id,max(data_levantamento) data_levantamento from ( "
            + "Select p.patient_id,max(e.encounter_datetime) data_levantamento from patient p "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "where p.voided=0 and e.voided=0 and e.encounter_type=6 and "
            ...
            + "inner join obs on obs.person_id=ultima_carga.patient_id and obs.obs_datetime=ultima_carga.data_carga "
            + "where obs.voided=0 and ((obs.concept_id=856 and obs.value_numeric>=1000) or (obs.concept_id=1305 and obs.value_coded in (1306,23814,23905,23906,23907,23908,23904)))  and obs.location_id=:location) carga_viral on levantamento_consulta.patient_id=carga_viral.patient_id "
            + "where carga_viral.data_carga<=date_sub(levantamento_consulta.data_levantamento, interval 3 MONTH) "
            ...
            + "e.encounter_datetime >=:startDate and e.encounter_datetime<=:endDate and e.location_id=:location "
            ...
            + "inner join obs obsGravida on e.encounter_id=obsGravida.encounter_id "
            + "where pe.voided=0 and p.voided=0 and e.voided=0 and obsGravida.voided=0 and e.encounter_type in(5,6) and e.location_id=:location and "
            + "obsGravida.concept_id=1279 and obsGravida.value_numeric is not null and pe.gender='F' "
            + "and e.encounter_datetime between (:endDate - INTERVAL 9 MONTH) and :endDate "
            + "group by p.patient_id "
            + "union "
            + " Select p.patient_id,  min(e.encounter_datetime) from person pe "
            ...
            + "inner join obs obsGravida on e.encounter_id=obsGravida.encounter_id "
            + "where pe.voided=0 and p.voided=0 and e.voided=0 and obsGravida.voided=0 and e.encounter_type in(5,6) and e.location_id=:location and "
            + "obsGravida.concept_id=1600 and obsGravida.value_datetime is not null and pe.gender='F' "
            ...
            + " pe.gender='F' and pp.location_id = 278 and pp.voided = 0 and pp.program_id = 8 "
            ...
            + "group by p.patient_id "
            + "union "
            + "   Select p.patient_id, obsGravida.value_datetime from person pe "
            + "inner join patient p on pe.person_id=p.patient_id "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs obsGravida on e.encounter_id=obsGravida.encounter_id "
            + "where pe.voided=0 and p.voided=0 and e.voided=0 and obsGravida.voided=0 and e.encounter_type=6 and e.location_id=:location and "
            ...
            + "group by p.patient_id "
            + "union "
            + " Select p.patient_id, max(e.encounter_datetime) encounter_datetime from person pe "
            + "inner join patient p on pe.person_id=p.patient_id "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "inner join obs obsLactante on e.encounter_id=obsLactante.encounter_id "
    ...
    public static final String findPatientsEligibleToViralLoad =
        "	select inicio.patient_id "
            ...
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "where p.voided=0 and e.voided=0 and e.encounter_type=35 and "
            + "e.encounter_datetime >='2019-01-01' and e.encounter_datetime<=:endDate and e.location_id=:location "
            + ") apss on apss.patient_id = carga_viral.patient_id "
            + "where apss.encounter_datetime between carga_viral.data_carga and :endDate "
            + "order by apss.patient_id "
            + ") apss group by patient_id "
