  ...
  class QUERY {
    ...
    public static final String findPatientsEligibleToViralLoadList =
        "select 	marcadoVisita.patient_id, "
            ...
            + "	from "
            + "	( "
            + "		select patient_id,max(data_consulta) data_consulta,min(data_proxima_consulta) data_proxima_consulta "
            + "		from "
            + "		( "
            + " "
            ...
            + "	left join "
            + "	( "
            + "		Select 	p.patient_id,o.concept_id,o. value_coded value_numeric,o.obs_datetime data_carga "
            + "		from 	patient p "
            + "				inner join encounter e on p.patient_id=e.patient_id "
            + "				inner join obs o on e.encounter_id=o.encounter_id "
            + "		where 	p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (13,6,9,53,51) and "
            + "				o.concept_id=1305 and o.obs_datetime <=:endDate and e.location_id=:location "
            + " "
            + "		union "
            + " "
            + "		Select 	p.patient_id,o.concept_id,o.value_numeric,o.obs_datetime data_carga "
            + "		from 	patient p "
            + "				inner join encounter e on p.patient_id=e.patient_id "
            + "				inner join obs o on e.encounter_id=o.encounter_id "
            + "		where 	p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (13,6,9,53,51) and "
            + "				o.concept_id=856 and o.obs_datetime<=:endDate and e.location_id=:location "
            + " "
            ...
            + "		( "
            + " "
            + "			/*Patients that are female and were marked as “PREGNANT” in the initial consultation or follow-up consultation "
            + "			Patients that are female and have registered as pregnant in Ficha Clinica – Master Card between start and end date "
            + "			*/ "
            ...
            + "			union "
            + " "
            + "			/*Patients that are female and have “Pregnancy Due Date” registered in the initial or follow-up consultation between start and end date*/ "
            + "			Select 	p.patient_id,e.encounter_datetime data_gravida "
            + "			from 	patient p inner join encounter e on p.patient_id=e.patient_id "
            + "					inner join obs o on e.encounter_id=o.encounter_id "
            ...
            + "			union "
            + " "
            + "			/*Patients that started ART for being B+ as specified in “CRITÉRIO PARA INÍCIO DE TARV” in the follow-up consultations (Ficha de Seguimento) between start and end date*/ "
            + "			Select 	p.patient_id,e.encounter_datetime data_gravida "
            + "			from 	patient p "
            + "					inner join encounter e on p.patient_id=e.patient_id "
            + "					inner join obs o on e.encounter_id=o.encounter_id "
            ...
            + "			union "
            + " "
            + "			/*Patients that are female and enrolled on PTV/ETC program (patient program id =8) between start date and end date (patient program date_enrolled)*/ "
            ...
            + "			union "
            + " "
            + "			/*Patients that are female and have registered as pregnat in Ficha Resumo – Master Card between start and end date*/ "
            ...
            + "			union "
            + " "
            + "			/*Patients with date of last menstrual period between start and end date*/ "
            ...
            + "			union "
            + " "
            + "			/*Patients that are female and have the “Delivery date” (obs concept id 5599) registered in the initial or follow-up consultation where delivery date is between start and end date*/ "
            + " "
            ...
            + "			union "
            + " "
            + "			/* 	Patients that are female and have registered as breastfeeding in follow up consultation between start and end date (encounter datetime). "
            + "				Patients that are female and have registered as breastfeeding in Ficha Clinica between start and end date (encounter datetime). "
            + "			*/ "
            ...
            + " "
            + "			/* "
            + "				Patients that are female and have registered as breastfeeding in Ficha Resumo between start and end date (encounter datetime). "
            + "			*/ "
            ...
            + "			union "
            + " "
            + "			/*Patients that are female and have started ART for being breastfeeding as specified in “CRITÉRIO PARA INICIO DE TRATAMENTO ARV” "
            + "			with response equal to “LACTACAO” in the initial or follow-up consultation between start & end date */ "
            + "			Select 	p.patient_id, e.encounter_datetime data_parto "
            + "			from 	patient p "
            + "					inner join encounter e on p.patient_id=e.patient_id "
            + "					inner join obs o on e.encounter_id=o.encounter_id "
            ...
            + " "
            + " "
            + "			/*Patients enrolled in PTV(ETV) Program*/ "
            + " "
            + "			union "
            + " "
            ...
            + "			(saida.patient_id is null or (saida.patient_id is not null and consultaLevantamento.data_consulta>saida.data_estado)) and "
            + "			timestampdiff(month,inicio_real.data_inicio,:endDate)> 5 "
            + ") marcadoVisita "
            + "left join "
            + "( "
    ...
    public static final String findPatientsEligibleToViralLoad =
        "select 	marcadoVisita.patient_id "
            ...
            + "				inner join obs o on e.encounter_id=o.encounter_id "
            + "		where 	p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (13,6,9,53,51) and "
            + "				o.concept_id=1305 and o.obs_datetime <=:startDate and e.location_id=:location "
            + " "
            + "		union "
            + " "
            + "		Select 	p.patient_id,o.concept_id,o.value_numeric,o.obs_datetime data_carga "
            ...
            + "				inner join obs o on e.encounter_id=o.encounter_id "
            + "		where 	p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (13,6,9,53,51) and "
            + "				o.concept_id=856 and o.obs_datetime<=:startDate and e.location_id=:location "
            + " "
            + "	) carga_viral on consultaLevantamento.patient_id=carga_viral.patient_id and "
            + "		( "
            + "			(carga_viral.concept_id=1305 and carga_viral.data_carga between date_add(consultaLevantamento.data_proxima_consulta, interval -12 MONTH) and consultaLevantamento.data_proxima_consulta) or "
