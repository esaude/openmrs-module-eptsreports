  ...
  class QUERY {
    ...
    public static String findPatiendsWithDuplicatedFichaResumo =
        "SELECT "
            ...
            + ",person.birthdate, if(person.birthdate_estimated = true, 'SIM','NAO') birthdate_estimated , person.gender , patient.date_created "
            ...
            + "inner JOIN patient_state ps ON (patient_program.patient_program_id = ps.patient_program_id and ps.state = 6) "
            ...
            + " on p.patient_id = pp.patient_id where pp.patient_id = patient.patient_id and pp.program_id = 2 "
