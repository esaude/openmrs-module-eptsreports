...
public class AgeCohortQueries {
	...
	public CohortDefinition createXtoYAgeCohort(String name, int minAge,
			int maxAge) {
		...
		xToYCohort.addParameter(new Parameter("effectiveDate", "endDate",
				Date.class));
		return xToYCohort;
	}
	...
	public CohortDefinition createOverXAgeCohort(String name, int minAge) {
		...
		overXCohort.addParameter(new Parameter("effectiveDate", "endDate",
				Date.class));
		return overXCohort;
	}
