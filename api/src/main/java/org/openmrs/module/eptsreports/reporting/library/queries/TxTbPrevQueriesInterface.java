  ...
  class QUERY {
    ...
    public static final String findPatientsWhoStartedArtAndTpiNewDessagragation =
        "select inicio_tpi.patient_id from ( "
            ...
            + "inner join obs o on o.encounter_id=e.encounter_id "
            + "where e.voided=0 and p.voided=0 and o.value_datetime between :startDate - interval 6 month and :endDate - interval 6 month and "
            + "o.voided=0 and o.concept_id=6128 and e.encounter_type in (6,9,53) and e.location_id=5 group by p.patient_id "
            + "union "
            + "select p.patient_id,min(e.encounter_datetime) data_inicio_tpi from  patient p "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on o.encounter_id=e.encounter_id "
            + "where e.voided=0 and p.voided=0 and e.encounter_datetime between :startDate - interval 6 month and :endDate - interval 6 month and "
            + "o.voided=0 and o.concept_id=6122 and o.value_coded=1256 and e.encounter_type=6 and  e.location_id=5 group by p.patient_id) startTPI group by patient_id) inicio_tpi "
            ...
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on o.encounter_id=e.encounter_id "
            + "where e.voided=0 and o.voided=0 and p.voided=0 and  e.encounter_type in (18,6,9) and o.concept_id=1255 and o.value_coded=1256 and e.encounter_datetime<=:endDate and e.location_id=5 group by p.patient_id "
            + "union "
            + "select p.patient_id,min(value_datetime) data_inicio from  patient p "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (18,6,9,53) and  o.concept_id=1190 and o.value_datetime is not null and  o.value_datetime<=:endDate and e.location_id=5 group by p.patient_id "
            + "union "
            + "select pg.patient_id,min(date_enrolled) data_inicio from patient p "
            + "inner join patient_program pg on p.patient_id=pg.patient_id "
            + "where pg.voided=0 and p.voided=0 and program_id=2 and date_enrolled<=:endDate and location_id=5 group by pg.patient_id "
            + "union "
            ...
            + "p.voided=0 and e.encounter_type=18 AND e.voided=0 and e.encounter_datetime<=:endDate and e.location_id=5 GROUP BY  p.patient_id "
            + "union "
            + "select p.patient_id,min(value_datetime) data_inicio from patient p "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=52 and "
            + "o.concept_id=23866 and o.value_datetime is not null and  o.value_datetime<=:endDate and e.location_id=5 group by p.patient_id) inicio_real group by patient_id) "
    ...
    public static final String findPatientsTransferredOut =
        "select transferidopara.patient_id from ( "
            ...
            + "where pg.voided=0 and ps.voided=0 and p.voided=0 and  pg.program_id=2 and ps.state=7 and ps.end_date is null and  ps.start_date<=:endDate and location_id=:location group by p.patient_id "
            + "union "
