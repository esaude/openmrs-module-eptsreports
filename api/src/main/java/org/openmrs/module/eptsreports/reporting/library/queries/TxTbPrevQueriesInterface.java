    ...
    public static final String
        findPatientsWhoCompletedTbPrevPreventiveTreatmentDuringReportingPeriod =
            "                                                                                                             	 	"
                ...
                + "						inner join encounter e on p.patient_id=e.patient_id																	"
                + "						inner join obs o on o.encounter_id=e.encounter_id																	"
                + "				where 	e.voided=0 and p.voided=0 and e.encounter_datetime between (:startDate - INTERVAL 10 MONTH) and (:endDate - interval 6 month) and																	"
                + "						o.voided=0 and o.concept_id=1719 and o.value_coded=23954 and e.encounter_type in (6,9) and  e.location_id=:location																	"
                ...
                + "		inner join obs o on o.encounter_id=e.encounter_id																	"
                + "		where 	e.voided=0 and o.voided=0 and o.concept_id=1719 and o.value_coded=23954 and e.encounter_type in (6,9) and e.location_id=:location and 																	"
                + "				e.encounter_datetime between inicio3hp.data_inicio_tpi and (inicio3hp.data_inicio_tpi + INTERVAL 4 month)																	"
                ...
                + "				e.encounter_type=60 and e.location_id=:location and e.encounter_datetime between inicio3hp.data_inicio_tpi and (inicio3hp.data_inicio_tpi + INTERVAL 4 month) and 																	"
                + "				obs3hp.concept_id=23985 and obs3hp.value_coded in (23954,23984) and 																	"
                ...
                + "		inner join obs obsTipo on obsTipo.encounter_id=e.encounter_id																	"
                + "		where 	e.voided=0 and obs3hp.voided=0 and obsTipo.voided=0 and 																	"
                + "				e.encounter_type=60 and e.location_id=:location and e.encounter_datetime between inicio3hp.data_inicio_tpi and :endDate and 																	"
                + "				obs3hp.concept_id=23985 and obs3hp.value_coded in (23954,23984) and 																	"
                ...
                + "							inner join encounter e on p.patient_id=e.patient_id																	"
                + "							inner join obs o on o.encounter_id=e.encounter_id																	"
                + "					where 	e.voided=0 and p.voided=0 and e.encounter_datetime between (:startDate - INTERVAL 13 MONTH) and (:endDate - interval 6 month) and																	"
                + "							o.voided=0 and o.concept_id=23985 and o.value_coded in (656,23982) and e.encounter_type=60 and  e.location_id=:location																	"
                + "																						"
                + "				) inicioAnterior on inicioAnterior.patient_id=inicio.patient_id and 																	"
                ...
                + "							inner join encounter e on p.patient_id=e.patient_id																	"
                + "							inner join obs o on o.encounter_id=e.encounter_id																	"
                + "					where 	e.voided=0 and p.voided=0 and o.value_datetime between (:startDate - INTERVAL 13 MONTH) and (:endDate - interval 6 month) and																	"
                + "							o.voided=0 and o.concept_id=6128 and e.encounter_type in (6,9,53) and e.location_id=:location																	"
                + "				) inicioAnterior on inicioAnterior.patient_id=inicio.patient_id and 																	"
                + "									inicioAnterior.data_inicio_tpi between (inicio.data_inicio_tpi - INTERVAL 7 MONTH) and (inicio.data_inicio_tpi - INTERVAL 1 day)																	"
                + "				where inicioAnterior.patient_id is null																	"
                ...
                + "				obsLevTPI.concept_id=6122 and obsLevTPI.value_coded in (1257,1065,1256) and obsDTINH.concept_id is null and e.location_id=:location																	"
                ...
                + "				e.encounter_datetime between inicio_tpi.data_inicio_tpi and (inicio_tpi.data_inicio_tpi + INTERVAL 7 MONTH) and 																	"
                + "				obsLevTPI.concept_id=23985 and obsLevTPI.value_coded in (656,23982) and e.location_id=:location																	"
                + "		group by inicio_tpi.patient_id																	"
                + "		having count(*)>=6																			"
                + "		union																				"
                + "		select inicio_tpi.patient_id																	"
