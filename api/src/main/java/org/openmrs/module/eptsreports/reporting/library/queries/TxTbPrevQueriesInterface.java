...
public interface TxTbPrevQueriesInterface {
	...
	class QUERY {
		public static final String findPatientWhoStartedTpi = "select inicio_tpi.patient_id from ( "
		...
		public static final String findPatientsWhoStartedArtAndTpiNewDessagragation = "select inicio_tpi.patient_id from ( "
				...
				+ "union " + "select p.patient_id,min(e.encounter_datetime) data_inicio_tpi from  patient p "
				+ "inner join encounter e on p.patient_id=e.patient_id "
				+ "inner join obs o on o.encounter_id=e.encounter_id "
				+ "where e.voided=0 and p.voided=0 and e.encounter_datetime between :startDate - interval 6 month and :endDate - interval 6 month and "
		...
		public static final String findPatientsWhoStartedArtAndTpiPreviouslyDessagragation = "select inicio_tpi.patient_id from ( "
				+ "select patient_id, min(data_inicio_tpi) data_inicio_tpi from ( "
				+ "select p.patient_id,min(o.value_datetime) data_inicio_tpi from patient p "
				+ "inner join encounter e on p.patient_id=e.patient_id "
				+ "inner join obs o on o.encounter_id=e.encounter_id "
		...
		public static final String findPatientsWhoStartedTpi6MonthsAgoAndWhoEndedTpi = "select inicio_tpi.patient_id from ( "
				+ "select patient_id, min(data_inicio_tpi) data_inicio_tpi from( "
				+ "select p.patient_id,min(o.value_datetime) data_inicio_tpi from patient p "
				+ "inner join encounter e on p.patient_id=e.patient_id "
				+ "inner join obs o on o.encounter_id=e.encounter_id "
				...
				+ "where e.voided=0 and p.voided=0 and e.encounter_datetime between :startDate - interval 6 month and :endDate - interval 6 month and "
				+ "o.voided=0 and o.concept_id=6122 and o.value_coded=1256 and e.encounter_type=6 and  e.location_id=:location group by p.patient_id) startTPI group by patient_id ) inicio_tpi "
				+ "inner join (" + "select patient_id, max(data_final_tpi) data_final_tpi from ( "
				...
				+ "union  " + "select p.patient_id,max(e.encounter_datetime) data_final_tpi from patient p "
				+ "inner join encounter e on p.patient_id=e.patient_id "
				+ "inner join obs o on o.encounter_id=e.encounter_id "
				...
				+ "union " + "select inicio_tpi.patient_id from ( "
				+ "select patient_id, min(data_inicio_tpi) data_inicio_tpi from ( "
				+ "select p.patient_id,min(o.value_datetime) data_inicio_tpi from patient p "
				+ "inner join encounter e on p.patient_id=e.patient_id "
				+ "inner join obs o on o.encounter_id=e.encounter_id "
		...
		public static final String findPatientsTransferredOut = "select transferidopara.patient_id from ( "
				...
				+ "where pg.voided=0 and ps.voided=0 and p.voided=0 and  pg.program_id=2 and ps.state=7 and ps.end_date is null and ps.start_date>=:startDate – 6 months  and  ps.start_date<=:endDate and location_id=:location group by p.patient_id "
