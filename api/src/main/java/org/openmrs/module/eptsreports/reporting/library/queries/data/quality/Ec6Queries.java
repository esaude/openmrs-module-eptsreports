...
public class Ec6Queries {
  ...
  public static String getEc6CombinedQuery(
    ...
    String query =
        "SELECT patient_id, NID, Name, birthdate, Estimated_dob, Sex, First_entry_date, Last_updated, date_enrolled, state, state_date, MIN(encounter_date) AS encounter_date, encounter_date_created FROM("
            ...
            + ") encounter ON states.patient_id=encounter.patient_id) WHERE encounter.encounter_date > states.start_date)) f_ec6 GROUP BY f_ec6.patient_id";
    return query;
  }
}
