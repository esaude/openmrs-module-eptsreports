  ...
  public static String getEc3CombinedQuery(
    ...
    String query =
        "SELECT pe.person_id As patient_id, "
            ...
            + " DATE_FORMAT(recepcao.encounter_datetime, '%d-%m-%Y') AS encounter_date_recepcao, "
            + " DATE_FORMAT(recepcao.date_created, '%d-%m-%Y %H:%i:%s') AS encounter_date_created_recepcao, "
            + " fila.location_name AS location_name_fila, "
