...
public class SetupMERQuartelyML extends EptsDataExportManager {
    ...
    public ReportDefinition constructReportDefinition() {
        ...
        //TODO replace eriDSDDatset with a new dataset
        reportDefinition.addDataSetDefinition("ERIDSD-ML", Mapped.mapStraightThrough(eriDSDDataset.constructEriDSDDataset()));
