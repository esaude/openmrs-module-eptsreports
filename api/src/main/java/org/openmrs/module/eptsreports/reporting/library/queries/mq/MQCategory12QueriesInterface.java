    ...
    public static final String
        findPatientsWhoStartedARTInTheInclusionPeriodAndReturnedForClinicalConsultation99DaysAfterAtartingARTCategory12 =
            " SELECT patient_id FROM ( "
                ...
                + " GROUP BY patient_id "
                + " ) tx_new "
                + " inner join encounter primeira_consulta on tx_new.patient_id = primeira_consulta.patient_id and primeira_consulta.voided = 0 and primeira_consulta.encounter_type = 6 "
                + " and primeira_consulta.location_id = :location and (TIMESTAMPDIFF(DAY, tx_new.art_start_date, primeira_consulta.encounter_datetime)) between 20 and 33 "
                ...
                + " segunda_consulta.location_id = :location and (TIMESTAMPDIFF(DAY, tx_new.art_start_date, segunda_consulta.encounter_datetime)) between 34 and 66 "
                ...
                + " terceira_consulta.location_id = :location and (TIMESTAMPDIFF(DAY, tx_new.art_start_date, terceira_consulta.encounter_datetime)) between 67 and 99 "
                ...
                + " ) tx_new "
                + " inner join "
                + " (select e_.patient_id, o_.value_datetime, e_.encounter_datetime  from "
                + " encounter e_ "
                ...
                + " and (TIMESTAMPDIFF(DAY, tx_new.art_start_date, primeira_consulta.value_datetime)) between 20 and 33 "
                + " inner join "
                + " (select e_.patient_id, o_.value_datetime, e_.encounter_datetime  from "
                + " encounter e_ "
                + " inner join obs o ON o.encounter_id = e_.encounter_id and o.voided = 0 and o.concept_id = 23865 and o.value_coded = 1065 "
                + " inner join obs o_ ON o_.encounter_id = e_.encounter_id and o_.voided = 0 and o_.concept_id = 23866 "
                + " where e_.encounter_type = 52 and e_.location_id = :location and e_.voided = 0 "
                + " ) segunda_consulta ON segunda_consulta.patient_id = tx_new. patient_id "
                + " and (TIMESTAMPDIFF(DAY, tx_new.art_start_date, segunda_consulta.value_datetime)) between 34 and 66 "
                + " inner join "
                + " (select e_.patient_id, o_.value_datetime, e_.encounter_datetime  from "
                + " encounter e_ "
                + " inner join obs o ON o.encounter_id = e_.encounter_id and o.voided = 0 and o.concept_id = 23865 and o.value_coded = 1065 "
                + " inner join obs o_ ON o_.encounter_id = e_.encounter_id and o_.voided = 0 and o_.concept_id = 23866 "
                + " where e_.encounter_type = 52 and e_.location_id = :location and e_.voided = 0 "
                + " ) terceira_consulta ON terceira_consulta.patient_id = tx_new. patient_id "
                + " and (TIMESTAMPDIFF(DAY, tx_new.art_start_date, terceira_consulta.value_datetime)) between 67 and 99 "
                + " WHERE art_start_date BETWEEN :startInclusionDate AND :endInclusionDate "
                + " group by patient_id "
                + " ) ret99_ ";
