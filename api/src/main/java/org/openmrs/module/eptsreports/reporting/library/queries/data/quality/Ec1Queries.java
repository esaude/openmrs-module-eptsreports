  ...
  public static String getEc1CombinedQuery() {
    String query =
        " "
            ...
            + "gravida.criteria  criteria, "
            + "DATE_FORMAT(gravida.data_gravida, '%d-%m-%Y') AS data_criterio_gravida, "
            + "prog.state as state, "
            + "prog.date_enrolled  as state_date,"
            ...
            + "where p.voided=0 and e.voided=0 and o.voided=0 and concept_id=1982 and value_coded=1065 and e.encounter_type in (5,6,53) and e.encounter_datetime  between :startDate and :endDate and e.location_id in(:location) "
            + "union "
            ...
            + "union "
            + "Select p.patient_id,o.obs_datetime data_gravida, 'PC6' AS criteria  from patient p  "
            + "inner join encounter e on p.patient_id=e.patient_id  "
            + "inner join obs o on e.encounter_id=o.encounter_id  "
            ...
            + "WHERE  pg.program_id=8  AND ps.start_date IS NOT NULL  AND ps.end_date IS NULL  GROUP BY pa.patient_id "
