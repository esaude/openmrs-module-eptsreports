...
public class Ec1Queries {
  ...
  public static String getEc1CombinedQuery(
      ...
      int etvProgram) {
    String query =
        "SELECT preg_final.patient_id, preg_final.NID, preg_final.Name, preg_final.birthdate, preg_final.estimated_dob, preg_final.sex, preg_final.first_entry_date, preg_final.last_updated, preg_final.criteria, preg_final.encounter_date, prog.date_enrolled, prog.state, preg_final.location_name FROM ("
