  ...
  public static final String findPatientsWhoAreKeyPop(final KeyPopType keyPopType) {
    ...
    String query =
        "select patient_id from ( "
            ...
            + "where p.voided=0 and e.voided=0 and o.voided=0 and concept_id=23703 and  e.encounter_type=6 and e.encounter_datetime<=:endDate and  e.location_id=:location "
            ...
            + "where o.concept_id=23703 and o.voided=0 and e.encounter_type=6 and e.voided=0 and e.location_id=:location and pe.voided=0 and "
            + "((pe.gender='F' and o.value_coded=1901) or  (pe.gender='M' and o.value_coded=1377)) "
            + "	union "
            ...
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and o.voided=0 and concept_id=23703 and  e.encounter_type in (46,35) and e.encounter_datetime<=:endDate and  e.location_id=:location "
            + "group by p.patient_id "
            + ") maxkp "
            + "inner join encounter e on e.patient_id=maxkp.patient_id and maxkp.maxkpdate=e.encounter_datetime "
            + "inner join obs o on o.encounter_id=e.encounter_id and maxkp.maxkpdate=o.obs_datetime "
            + "where o.concept_id=23703 and o.voided=0 and e.encounter_type in (46,35) and e.voided=0 and e.location_id=:location and o.value_coded in (20454,20426) "
            + "union "
            ...
            + "inner join obs o on o.encounter_id=e.encounter_id and maxkp.maxkpdate=o.obs_datetime "
            + "inner join person pe on pe.person_id=maxkp.patient_id "
            + "where o.concept_id=23703 and o.voided=0 and e.encounter_type in (46,35) and e.voided=0 and e.location_id=:location and pe.voided=0 and "
            + "((pe.gender='F' and o.value_coded=1901) or  (pe.gender='M' and o.value_coded=1377)) "
            + "union "
            + "Select pa.person_id, "
            + "case upper(pa.value) "
            ...
            + "where pat.uuid='c89c90eb-5b03-4899-ab9f-06fecd123511' and pa.value is not null and pa.value<>'' and pa.voided=0 and date(pa.date_created)<=:endDate "
            + "and ((pe.gender='F' and pa.value='MTS') or (pe.gender='F' and pa.value='CSW') or (pe.gender='M' and pa.value='HSM') OR (pe.gender='M' and pa.value='HSH') or (pe.gender='M' and pa.value='MSM')) "
            + ") allkpsource "
